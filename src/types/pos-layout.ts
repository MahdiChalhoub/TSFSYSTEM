...
export type POSLayoutVariant = 'grid' | 'kiosk' | 'express';
...
export interface POSLayoutProps {
    ...
    lastOrder: { id: number; ref: string; fneStatus?: string | null; fneReference?: string | null; fneToken?: string | null } | null;
