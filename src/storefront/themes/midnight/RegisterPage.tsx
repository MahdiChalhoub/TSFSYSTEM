            ...
            <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden">
                ...
                <div className="max-w-md w-full text-center space-y-10 relative z-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-slate-500 text-sm leading-relaxed">Your account has been provisioned. Proceed to authentication.</p>
                    </div>
        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="max-w-md w-full relative z-10">
                <div className="text-center mb-12 space-y-4">
                    ...
                    <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">{orgName || slug}</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                        <div className="relative">
                            ...
                            <input type="text" placeholder="Full Name" value={name} onChange={e => setName(e.target.value)} required
                                className="w-full bg-slate-950/60 border border-white/5 pl-12 pr-5 py-4 rounded-2xl text-white outline-none focus:border-purple-500 transition-all placeholder:text-slate-800 font-medium" />
                        </div>
                        <div className="relative">
                        ...
                        <div className="relative">
                            <Building2 size={16} className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-600" />
                        ...
                        <div className="relative">
                            ...
                            <input type={showPass ? 'text' : 'password'} placeholder="Password (min 8 chars)" value={password} onChange={e => setPassword(e.target.value)} required
                                className="w-full bg-slate-950/60 border border-white/5 pl-12 pr-14 py-4 rounded-2xl text-white outline-none focus:border-purple-500 transition-all placeholder:text-slate-800 font-medium" />
                            <button type="button" onClick={() => setShowPass(!showPass)} className="absolute right-5 top-1/2 -translate-y-1/2 text-slate-600 hover:text-white transition-colors">
                ...
                <div className="text-center mt-10">
                    <Link href={path('/')} className="text-[10px] font-black uppercase tracking-widest text-slate-600 hover:text-white transition-colors flex items-center justify-center gap-2">
