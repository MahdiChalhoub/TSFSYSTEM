                ...
                {dashboard?.barcode && (
                    <div className="p-8 bg-slate-900/40 border border-white/5 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-6 group hover:border-emerald-500/30 transition-all duration-500">
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                <p className="text-[10px] text-slate-500 font-black uppercase tracking-[0.3em]">Identity Reference Tag</p>
    ...
    return (
        <div className={`p-8 bg-slate-900/60 border border-white/5 rounded-[2rem] space-y-4 transition-all duration-300 ${colors[color]} group`}>
            ...
            <div>
                ...
                <p className="text-[10px] text-slate-500 mt-1 uppercase font-bold tracking-wider">{meta}</p>
            </div>
        </div>
    )
}
...
function OperationCard({ title, description, path, icon, color }: any) {
    ...
    return (
        <Link href={path} className="group p-8 bg-slate-900/40 border border-white/5 rounded-[2.5rem] flex items-center gap-6 hover:border-white/10 transition-all duration-300">
            ...
            <ChevronRight size={20} className="text-slate-600 group-hover:text-emerald-500 group-hover:translate-x-1 transition-all" />
        </Link>
    )
}
