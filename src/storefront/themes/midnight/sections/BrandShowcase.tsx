                ...
                <div className="bg-gradient-to-br from-slate-900 to-black rounded-[4rem] p-10 md:p-20 border border-white/5 relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-16 relative z-10">
                        <div className="text-center md:text-left md:w-1/3">
                            <div className="inline-flex items-center gap-2 text-indigo-400 text-[10px] font-black uppercase tracking-[0.4em] mb-6 bg-app-info/10 px-4 py-2 rounded-full border border-app-info/20">
                            ...
                            <p className="text-app-muted-foreground text-lg font-medium leading-relaxed">
                                Curating the world's most innovative technologies. Integrated directly with our supply chain.
                            </p>
                        </div>
                        <div className="flex-1 grid grid-cols-2 lg:grid-cols-3 gap-4">
                            {brands.slice(0, 6).map(brand => (
                                <div key={brand.id} className="flex items-center justify-center p-8 h-32 bg-slate-800/20 rounded-[2rem] border border-white/[0.03] hover:border-app-info/40 hover:bg-slate-800/40 transition-all group cursor-pointer backdrop-blur-sm">
                                    {brand.logo ? (
                                        ...
                                        <span className="text-sm font-black text-app-muted-foreground group-hover:text-indigo-400 transition-colors uppercase tracking-[0.2em]">{brand.name}</span>
                                    )}
                                </div>
                            ))}
                        </div>
