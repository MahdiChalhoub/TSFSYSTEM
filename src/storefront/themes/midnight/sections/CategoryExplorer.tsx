                    ...
                    {categories.slice(0, 8).map((cat) => (
                        <div key={cat.id} className="group relative bg-slate-900 border border-white/10 rounded-3xl p-8 hover:border-emerald-500/50 hover:shadow-2xl hover:shadow-emerald-500/10 transition-all cursor-pointer overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center text-slate-400 mb-8 group-hover:bg-emerald-500/10 group-hover:text-emerald-500 transition-all rotate-3 group-hover:rotate-0">
                                    <LayoutGrid size={28} />
                                </div>
                            ...
                            <div className="absolute bottom-8 right-8 opacity-0 group-hover:opacity-100 transition-all translate-x-4 group-hover:translate-x-0">
                                <div className="w-10 h-10 rounded-full bg-emerald-500 text-slate-950 flex items-center justify-center shadow-lg shadow-emerald-500/20">
