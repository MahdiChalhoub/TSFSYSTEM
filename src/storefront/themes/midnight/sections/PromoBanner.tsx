    ...
    return (
        <section className="px-4 py-8">
            <div className="max-w-6xl mx-auto bg-gradient-to-br from-emerald-600/10 to-indigo-600/10 border border-white/5 rounded-[3rem] p-10 md:p-16 backdrop-blur-3xl relative overflow-hidden group">
                {/* Background flare */}
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-app-success/5 blur-[120px] -mr-64 -mt-64 transition-all group-hover:bg-app-success/10" />

                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                    <div className="text-center md:text-left flex-1">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-app-success/10 text-emerald-400 rounded-full text-[11px] font-black uppercase tracking-[0.2em] border border-app-success/20 mb-6">
