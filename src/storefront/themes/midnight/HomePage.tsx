    ...
    return (
        <div className="min-h-screen bg-slate-950">
                ...
                <div className="relative max-w-6xl mx-auto px-4 pt-8 pb-12">
                    ...
                    <nav className="flex items-center justify-between mb-12">
                        ...
                        <div className="flex items-center gap-4">
                            <Link href={`/tenant/${slug}/categories`} className="text-sm text-app-muted-foreground hover:text-white font-medium transition-colors">
                                Products
                            </Link>
                            <Link href={`/tenant/${slug}/categories`} className="text-sm text-app-muted-foreground hover:text-white font-medium transition-colors">
                                Categories
                            ...
                            <Link href={`/tenant/${slug}/cart`} className="w-10 h-10 flex items-center justify-center text-app-muted-foreground hover:text-white transition-colors">
                                <ShoppingBag size={20} />
                            </Link>
                            <Link href={`/tenant/${slug}/register`} className="px-5 py-2.5 bg-app-success text-white rounded-xl text-xs font-bold hover:bg-app-success transition-all shadow-lg shadow-emerald-900/30">
                                Sign In
                            </Link>
                        </div>
                    </nav>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            ...
                            <p className="text-lg text-app-muted-foreground leading-relaxed max-w-md">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex items-center gap-2 px-5 py-3 bg-white/5 border border-white/10 rounded-2xl">
                                    ...
                                    <span className="text-xs text-app-muted-foreground">Products</span>
                                </div>
                                <div className="flex items-center gap-2 px-5 py-3 bg-white/5 border border-white/10 rounded-2xl">
                                    <Grid3x3 size={18} className="text-indigo-400" />
                                    <span className="text-sm font-bold text-white">{categories.length}</span>
                                    <span className="text-xs text-app-muted-foreground">Categories</span>
                                </div>
                            </div>
                        </div>
                        ...
                        {products.length > 0 && products[0]?.image_url ? (
                            ...
                            <div className="relative hidden lg:block">
                                <div className="bg-slate-900/40 border border-white/5 rounded-[3rem] p-12 text-center aspect-square flex flex-col items-center justify-center">
                                    <ShoppingBag size={64} className="text-app-foreground mb-4" />
                                    <h3 className="text-xl font-bold text-white">Catalog Coming Soon</h3>
                                    <p className="text-app-muted-foreground mt-2 text-sm">Products will appear here</p>
                                </div>
                            </div>
                        )}
                    </div>
            ...
            <div className="max-w-6xl mx-auto px-4 py-8 text-center">
                <p className="text-[10px] text-app-foreground font-bold uppercase tracking-widest">
