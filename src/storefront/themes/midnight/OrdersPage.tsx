                ...
                {loading ? (
                    ...
                    <div className="py-24 text-center space-y-8 bg-slate-900/20 border border-white/5 rounded-[3.5rem]">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-500 text-sm">Your commerce history is currently empty. Initialize a new stream.</p>
                        </div>
                        <Link href={path('/')}
                        ...
                        {orders.map(order => {
                            ...
                            return (
                                <Link key={order.id} href={path(`/account/orders/${order.id}`)}
                                    className="p-8 bg-slate-900/40 border border-white/5 rounded-[2.5rem] flex items-center gap-8 hover:border-emerald-500/30 transition-all cursor-pointer group hover:bg-slate-900/60 shadow-2xl shadow-black/20">
                                    ...
                                    <div className="text-right space-y-1">
                                        ...
                                        {order.delivery_rating ? (
                                            ...
                                            <div className="text-[10px] text-slate-700 font-bold uppercase tracking-widest">Awaiting Delivery</div>
                                        )}
                                    </div>
                                    <ChevronRight size={20} className="text-slate-800 group-hover:text-emerald-500 group-hover:translate-x-1 transition-all" />
                                </Link>
                            )
                        })}
                    </div>
