                    ...
                    <div className="lg:col-span-7 space-y-4">
                        <div className="bg-app-surface rounded-[2rem] border border-app-border overflow-hidden aspect-square flex items-center justify-center relative group shadow-sm">
                            ...
                            <div className="absolute top-6 right-6 flex flex-col gap-3">
                                <button className="w-12 h-12 bg-white/90 backdrop-blur-sm rounded-2xl border border-app-border flex items-center justify-center text-app-muted-foreground hover:text-rose-500 transition-all shadow-sm">
                                    <Heart size={20} />
                                </button>
                                <button className="w-12 h-12 bg-white/90 backdrop-blur-sm rounded-2xl border border-app-border flex items-center justify-center text-app-muted-foreground hover:text-indigo-500 transition-all shadow-sm">
                                    <Share2 size={20} />
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="bg-app-surface rounded-[2rem] border border-app-border p-8 shadow-sm space-y-6">
                                ...
                                <div className="p-4 bg-app-bg rounded-2xl border border-app-border space-y-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-xs">
                                            ...
                                            <p className="text-app-muted-foreground font-bold">Delivery by Wednesday, Feb 25 • <span className="text-emerald-600">FREE</span></p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                            ...
                            <div className="flex gap-4">
                                <button
                                    ...
                                    className="flex-1 h-16 bg-yellow-400 hover:bg-yellow-500 text-app-foreground rounded-2xl font-black text-sm shadow-xl shadow-yellow-200/50 active:scale-95 transition-all flex items-center justify-center gap-3"
                                >
