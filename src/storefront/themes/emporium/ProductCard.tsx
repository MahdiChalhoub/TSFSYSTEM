                ...
                <div className="flex-1 flex flex-col justify-between py-1">
                    <div>
                        ...
                        <Link href={`/tenant/${slug}/product/${product.id}`}>
                            <h3 className="text-lg font-black text-app-foreground leading-tight hover:text-indigo-600 transition-colors">{product.name}</h3>
                        </Link>
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <button
                            ...
                            className="bg-yellow-400 hover:bg-yellow-500 text-app-foreground px-6 py-2.5 rounded-xl font-black text-xs flex items-center gap-2 shadow-lg shadow-yellow-200 active:scale-95 transition-all"
                        >
        ...
        <div className="group bg-app-surface rounded-2xl border border-app-border overflow-hidden hover:shadow-2xl hover:shadow-slate-200/50 hover:border-yellow-400/50 transition-all flex flex-col">
            ...
            <div className="p-4 flex-1 flex flex-col">
                <div className="flex-1 space-y-2">
                    ...
                    <Link href={`/tenant/${slug}/product/${product.id}`}>
                        <h3 className="text-sm font-black text-app-foreground leading-snug hover:text-indigo-600 transition-colors line-clamp-2">
                            {product.name}
                        </h3>
                    </Link>
                </div>
