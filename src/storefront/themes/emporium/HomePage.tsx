                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <aside className="hidden lg:block w-72 shrink-0 space-y-6">
                        <div className="bg-app-surface rounded-2xl border border-app-border shadow-sm overflow-hidden">
                            <div className="p-5 border-b border-app-border bg-slate-50/50">
                            ...
                            <nav className="p-2">
                                <button
                                    ...
                                    className={`w-full text-left px-4 py-2.5 rounded-xl text-sm font-bold transition-all flex items-center justify-between group ${!selectedCategory ? 'bg-yellow-400 text-app-text shadow-sm' : 'hover:bg-app-surface-2'}`}
                                >
                                ...
                                {categories.map(cat => (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-2.5 rounded-xl text-sm font-bold transition-all flex items-center justify-between group ${selectedCategory === cat.name ? 'bg-yellow-400 text-app-text shadow-sm' : 'hover:bg-app-surface-2 text-app-text-muted'}`}
                                    >
                                        {cat.name}
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <div className="bg-app-surface p-4 rounded-2xl border border-app-border shadow-sm space-y-4 lg:space-y-0 lg:flex lg:items-center lg:gap-4">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full bg-app-bg border border-app-border rounded-xl py-3 pl-12 pr-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition-all placeholder:text-app-text-faint"
                                />
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="flex bg-app-surface-2 p-1 rounded-xl">
                                    <button
                                        ...
                                        className={`p-2 rounded-lg transition-all ${layout === 'grid' ? 'bg-app-surface text-indigo-600 shadow-sm' : 'text-app-text-faint hover:text-app-text-muted'}`}
                                    >
                                        <LayoutGrid size={18} />
                                    </button>
                                    <button
                                        onClick={() => setLayout('compact')}
                                        className={`p-2 rounded-lg transition-all ${layout === 'compact' ? 'bg-app-surface text-indigo-600 shadow-sm' : 'text-app-text-faint hover:text-app-text-muted'}`}
                                    >
                                        <List size={18} />
                                    </button>
                                </div>
                                <button className="flex items-center gap-2 px-4 py-2.5 bg-app-surface-2 rounded-xl text-sm font-bold text-app-text-muted hover:bg-app-border transition-all">
                                    <ArrowUpDown size={16} /> Sort
                                </button>
                                <button className="lg:hidden flex items-center gap-2 px-4 py-2.5 bg-app-surface-2 rounded-xl text-sm font-bold text-app-text-muted hover:bg-app-border transition-all">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-app-text-faint font-bold uppercase tracking-widest flex items-center gap-2">
                        ...
                        {filtered.length === 0 ? (
                            <div className="bg-app-surface rounded-3xl border border-app-border p-20 text-center space-y-4">
                                ...
                                <h3 className="text-xl font-bold text-app-text">No matches found</h3>
                                <p className="text-app-text-faint max-w-xs mx-auto text-sm">We couldn't find what you're looking for. Try a different category or search term.</p>
                                <button
                                    onClick={() => { setSearch(''); setSelectedCategory(null) }}
                                    className="px-6 py-2.5 bg-yellow-400 text-app-text rounded-xl text-sm font-black shadow-lg shadow-yellow-200/50"
                                >
                                    CLEAR ALL FILTERS
                                </button>
                            </div>
                        ...
                        <div className="flex justify-center pt-8 pb-12">
                            <div className="bg-app-surface rounded-2xl border border-app-border p-1.5 flex gap-1 shadow-sm">
                                <button className="w-10 h-10 flex items-center justify-center rounded-xl bg-yellow-400 text-app-text font-black text-sm">1</button>
                                <button className="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-app-bg text-app-text-faint font-bold text-sm">2</button>
                                <button className="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-app-bg text-app-text-faint font-bold text-sm">3</button>
                                <div className="w-10 h-10 flex items-center justify-center text-slate-300">...</div>
                                <button className="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-app-bg text-app-text-faint font-bold text-sm">
