            ...
            <div className="relative z-10 max-w-lg w-full text-center space-y-8">
                ...
                <div className="flex justify-center">
                    <div className="relative">
                        <div className="w-28 h-28 bg-app-gradient-surface rounded-[2rem] flex items-center justify-center border border-app-border-strong/50 shadow-2xl">
                        ...
                        <div className="absolute -top-2 -right-2 w-8 h-8 bg-app-warning rounded-xl flex items-center justify-center shadow-lg shadow-amber-500/30">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-app-foreground">
                ...
                <div className="bg-app-surface-2/50 border border-app-border-strong/50 rounded-2xl p-4 inline-block backdrop-blur-sm">
                    <p className="text-xs font-black text-app-muted-foreground uppercase tracking-widest mb-1">Requested Workspace</p>
                    <p className="text-app-foreground font-mono font-bold text-lg">
                        ...
                        <span className="text-app-muted-foreground">{PLATFORM_CONFIG.suffix}</span>
                    </p>
                </div>
                ...
                <div className="space-y-3 pt-2">
                    <Link
                        ...
                        className="block w-full py-4 px-8 bg-app-primary-dark hover:bg-app-primary text-app-foreground font-black text-sm uppercase tracking-widest rounded-2xl shadow-lg shadow-emerald-900/30 transition-all hover:shadow-emerald-500/20 hover:-translate-y-0.5"
                    >
                ...
                {/* Footer hint */}
                <p className="text-xs text-app-muted-foreground pt-4">
