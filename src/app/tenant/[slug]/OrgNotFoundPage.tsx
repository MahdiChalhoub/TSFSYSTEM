        ...
        <div className="min-h-screen bg-[#020617] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-lg w-full text-center space-y-8">
                ...
                <div className="bg-slate-800/50 border border-slate-700/40 rounded-2xl p-5 backdrop-blur-sm mx-auto max-w-sm">
                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2">Requested Address</p>
                    <p className="text-slate-300 font-mono font-bold text-lg">
                        ...
                        <span className="text-slate-600">.{rootDomain}</span>
                    </p>
                </div>

                {/* Possible reasons */}
                <div className="bg-slate-800/30 border border-slate-700/30 rounded-2xl p-5 text-left space-y-3 max-w-sm mx-auto">
                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">This could mean</p>
                    <div className="space-y-2">
                        <div className="flex items-start gap-3">
                            <div className="w-1.5 h-1.5 rounded-full bg-amber-500 mt-2 shrink-0" />
                            <p className="text-sm text-slate-400">The workspace name is misspelled</p>
                        </div>
                        <div className="flex items-start gap-3">
                            <div className="w-1.5 h-1.5 rounded-full bg-amber-500 mt-2 shrink-0" />
                            <p className="text-sm text-slate-400">The organization hasn&apos;t been created yet</p>
                        </div>
                        <div className="flex items-start gap-3">
                            <div className="w-1.5 h-1.5 rounded-full bg-amber-500 mt-2 shrink-0" />
                            <p className="text-sm text-slate-400">The workspace was removed by its owner</p>
                        </div>
                    </div>
                </div>
