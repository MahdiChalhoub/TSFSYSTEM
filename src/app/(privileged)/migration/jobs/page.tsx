...
export default function JobsListPage() {
  ...
  const settings = useListViewSettings('migration_jobs', {
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<Jobs>
        ...
        headerExtra={
          <Button
            onClick={() => router.push('/migration/jobs/new')}
        ...
        actions={{
          onView: (r) => router.push(`/migration/jobs/${r.id}`),
          onEdit: (r) => router.push(`/migration/jobs/${r.id}/edit`),
        }}
      >
        <TypicalFilter
