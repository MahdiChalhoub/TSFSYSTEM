...
export default function ProductDashboardStats({ stats }: StatsProps) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-in slide-in-from-top-4 duration-700">
            {/* Health Score Card */}
            <div className="relative group overflow-hidden bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-emerald-500/5 transition-all">
                ...
                <div className="relative flex flex-col gap-4">
                    ...
                    <div>
                        <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest">Catalog Integrity</h4>
                        <div className="flex items-baseline gap-2">
                            <span className="text-3xl font-black text-gray-900 leading-tight">Elite</span>
            ...
            <div className="relative group overflow-hidden bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-blue-500/5 transition-all">
                <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:scale-110 group-hover:opacity-[0.07] transition-all">
                ...
                <div className="relative flex flex-col gap-4">
                    ...
                    <div>
                        <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest">Total SKUs</h4>
                        <div className="flex items-baseline gap-2">
                            <span className="text-3xl font-black text-gray-900 leading-tight">{stats.total_products}</span>
            ...
            <div className="relative group overflow-hidden bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-amber-500/5 transition-all">
                <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:scale-110 group-hover:opacity-[0.07] transition-all">
                ...
                <div className="relative flex flex-col gap-4">
                    ...
                    <div>
                        <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest">Missing Barcodes</h4>
                        <div className="flex items-baseline gap-2">
                            <span className="text-3xl font-black text-gray-900 leading-tight">{stats.missing_barcode}</span>
            ...
            <div className={`relative group overflow-hidden p-6 rounded-[2rem] border transition-all ${stats.zero_selling_price > 0 ? 'bg-red-50 border-red-100 hover:shadow-red-500/5' : 'bg-white border-gray-100 hover:shadow-emerald-500/5'}`}>
                <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:scale-110 group-hover:opacity-[0.07] transition-all">
                ...
                <div className="relative flex flex-col gap-4">
                    ...
                    <div>
                        <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest">Pricing Gaps</h4>
                        <div className="flex items-baseline gap-2">
                            <span className={`text-3xl font-black leading-tight ${stats.zero_selling_price > 0 ? 'text-red-600' : 'text-gray-900'}`}>{stats.zero_selling_price}</span>
