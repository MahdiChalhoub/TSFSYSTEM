...
export default function PurchaseReturnsPage() {
 ...
 key: 'id',
 label: 'Debit ID',
 render: (ret) => <span className="font-black text-app-text leading-tight">PRET-{ret.id}</span>
 },
 {
 key: 'original_order',
 label: 'Source PO',
 ...
 <div className="w-6 h-6 rounded bg-app-bg border border-app-border flex items-center justify-center text-app-text-faint group-hover/link:text-indigo-600 group-hover/link:bg-indigo-50 transition-colors">
 <Hash size={10} />
 </div>
 ...
 align: 'right',
 render: (ret) => (
 <span className="font-black text-app-text tracking-tighter">{fmt(parseFloat(String(ret.total_amount || 0)))}</span>
 )
 },
 {
 key: 'actions',
 ...
 <Button
 size="sm"
 className="h-8 px-4 bg-blue-600 hover:bg-blue-700 text-app-text font-black text-[10px] uppercase tracking-widest rounded-xl transition-all shadow-sm shadow-blue-100 gap-1.5"
 ...
 <p className="text-sm font-medium text-app-text-faint mt-2 uppercase tracking-widest">Outbound Restitution & Supplier Claims</p>
 </div>
 <div className="flex items-center gap-3">
 <Button onClick={loadReturns} variant="ghost" className="h-12 w-12 p-0 rounded-2xl text-app-text-faint hover:text-blue-600 hover:bg-blue-50 border border-transparent hover:border-blue-100 transition-all">
