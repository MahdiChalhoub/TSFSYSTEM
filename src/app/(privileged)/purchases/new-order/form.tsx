...
export default function FormalOrderForm({
 ...
 {/* Logistics */}
 <div className="bg-app-surface p-5 rounded-3xl border border-app-border shadow-sm flex flex-col justify-center">
 <label className="text-[10px] font-black text-app-text-faint uppercase tracking-widest mb-2 text-center">Destination Site</label>
 ...
 <div className="bg-app-surface p-5 rounded-3xl border border-app-border shadow-sm flex flex-col justify-center">
 <label className="text-[10px] font-black text-app-text-faint uppercase tracking-widest mb-2 text-center">Warehouse</label>
 <select
 ...
 {/* Supplier */}
 <div className="bg-app-surface p-5 rounded-3xl border border-app-border shadow-sm flex flex-col justify-center">
 <label className="text-[10px] font-black text-app-text-faint uppercase tracking-widest mb-2 text-center">Supplier</label>
 <select
 ...
 <div className="p-4 bg-app-bg border-b flex items-center gap-4">
 ...
 <thead className="bg-[#F8FAFC] text-[10px] font-black text-app-text-faint uppercase tracking-widest border-b border-app-border">
 <tr>
 ...
 {lines.length === 0 ? (
 <tr>
 <td colSpan={5} className="p-20 text-center text-app-text-faint italic">
 ...
 <td className="p-6">
 <div className="font-bold text-app-text">{line.productName}</div>
 <div className="text-[10px] text-app-text-faint font-mono mt-1">{line.sku}</div>
 ...
 <td className="p-6 text-right font-black text-app-text whitespace-nowrap">
 ...
 <label className="text-[10px] font-black text-app-text-faint uppercase tracking-widest mb-3 block">Conditions & Observations</label>
 <textarea
 name="notes"
 rows={4}
 ...
 <span className="text-app-text-muted">Items Count</span>
...
function ProductSearch({ callback, siteId, supplierId }: { callback: (p: Record<string, any>) => void, siteId: number, supplierId: number }) {
 ...
 <input
 type="text"
 className="w-full bg-transparent p-2 pl-4 text-sm font-bold text-app-text placeholder:text-app-text-faint outline-none"
 ...
 >
 <div>
 <div className="font-bold text-sm text-app-text group-hover:text-indigo-700">{r.name}</div>
 <div className="text-[10px] text-app-text-faint">SKU: {r.sku} ΓÇó In Stock: {r.stockLevel}</div>
 </div>
