...
export default async function SourcingDashboardPage() {
 ...
 <BarChart3 size={28} className="text-app-text" />
 </div>
 Sourcing <span className="text-emerald-500">Hub</span>
 </h1>
 <p className="text-sm font-medium text-app-text-faint mt-2 uppercase tracking-widest">Vendor Performance & Optimization Opportunities</p>
 </div>
 </header>
 ...
 <div className="text-3xl font-black text-app-text mb-1">{kpi.value}</div>
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest">{kpi.label}</div>
 </div>
 ))}
 </div>
 ...
 <div className="p-8 border-b border-app-border flex justify-between items-center bg-gray-50/50">
 <div>
 <h3 className="text-xl font-black text-app-text tracking-tight">Market Benchmarking</h3>
 <p className="text-xs font-bold text-app-text-faint uppercase tracking-widest mt-1">Cross-vendor cost analysis</p>
 </div>
 </div>
 ...
 <thead>
 <tr className="text-[10px] font-black text-app-text-faint uppercase tracking-widest bg-app-surface">
 ...
 <td className="p-8">
 <div className="text-sm font-black text-app-text group-hover:text-emerald-600 transition-colors">{item.product__name}</div>
 <div className="text-[10px] text-app-text-faint font-mono mt-1">{item.product__sku}</div>
 </td>
 <td className="p-8">
 <span className="px-3 py-1.5 bg-app-surface-2 text-app-text-muted rounded-xl text-[10px] font-black uppercase tracking-wider">
 ...
 <span className="text-[10px] text-app-text-faint">Save {delta.toLocaleString()} {currency}/unit</span>
 </div>
 ) : (
 ...
 <div className="w-20 h-20 bg-app-bg rounded-full flex items-center justify-center text-gray-200">
 <BarChart3 size={40} />
 </div>
 <div>
 <h4 className="font-black text-app-text tracking-tight">No Sourcing Data Yet</h4>
 <p className="text-sm text-app-text-faint font-medium">Complete more purchases to build your sourcing database.</p>
 </div>
 </div>
 )}
 </div>
