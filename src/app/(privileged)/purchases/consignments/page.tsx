    ...
    {focusMode ? (
     ...
     <>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
       <div className="flex items-center gap-3"><div className="page-header-icon" style={{ background: 'var(--app-accent)', boxShadow: '0 4px 14px color-mix(in srgb, var(--app-accent) 30%, transparent)' }}><Handshake size={20} className="text-white" /></div><div><h1 className="text-lg md:text-xl font-black text-app-foreground tracking-tight">Consignment Settlements</h1><p className="text-[10px] md:text-[11px] font-bold text-app-muted-foreground uppercase tracking-widest">{settlements.length} Settlements · {pendingCount} Pending · {settledCount} Settled</p></div></div>
