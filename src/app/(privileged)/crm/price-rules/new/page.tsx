...
export default function CreatePriceRulesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('crm/price-rules/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/crm/price-rules'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new price rules to the system
          </p>
        </div>
      </div>
