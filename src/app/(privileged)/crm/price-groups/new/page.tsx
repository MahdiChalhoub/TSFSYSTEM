...
export default function CreatePriceGroupsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('crm/price-groups/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/crm/price-groups'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new price groups to the system
          </p>
        </div>
      </div>
