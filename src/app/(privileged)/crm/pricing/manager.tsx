        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-app-surface p-6 rounded-[40px] shadow-2xl shadow-violet-900/5 border border-app-border">
                ...
                <div className="flex gap-3">
                    <div className="relative">
                        <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-app-faint" size={18} />
                        <input
                            className="pl-12 pr-6 py-3 rounded-2xl bg-app-surface border-none focus:ring-4 focus:ring-violet-100 outline-none font-bold text-app-foreground placeholder:text-app-faint w-64"
                            placeholder="Search..."
                            value={search}
                        ...
                        .map((group) => (
                            <div key={group.id} className="group bg-app-surface p-8 rounded-[40px] border border-app-border hover:shadow-2xl hover:shadow-violet-900/5 transition-all relative overflow-hidden">
                                ...
                                <div className="mt-6 flex gap-4">
                                    <div className="bg-app-surface rounded-2xl p-4 flex-1 text-center">
            ...
            {tab === 'rules' && (
                <div className="space-y-4 pb-20">
                            ...
                            <div key={rule.id} className="group bg-app-surface p-6 rounded-[32px] border border-app-border hover:shadow-xl hover:shadow-violet-900/5 transition-all flex items-center gap-6">
                                ...
                                <div className="flex-1 space-y-1">
                                    ...
                                    <div className="flex items-center gap-4 text-xs font-bold text-app-muted-foreground">
                                        ...
                                        {!rule.contact_name && !rule.group_name && <span className="text-app-faint">Global rule</span>}
                                    </div>
                                </div>
                    ...
                    {priceRules.length === 0 && (
                        <div className="text-center py-20 text-app-faint font-bold">
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
                    <div className="bg-app-surface rounded-[40px] shadow-2xl w-full max-w-lg p-8 space-y-6 animate-in fade-in zoom-in duration-300">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-2xl bg-app-surface border-none focus:ring-4 focus:ring-violet-100 outline-none font-bold text-app-foreground"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 rounded-2xl bg-app-surface border-none focus:ring-4 focus:ring-violet-100 outline-none font-bold text-app-foreground resize-none"
                        ...
                        <div className="flex gap-4 pt-4">
                            <button onClick={() => setShowGroupForm(false)} className="flex-1 px-6 py-3 rounded-2xl font-black text-app-muted-foreground hover:bg-app-surface transition-all text-sm uppercase tracking-widest">Cancel</button>
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
                    <div className="bg-app-surface rounded-[40px] shadow-2xl w-full max-w-lg p-8 space-y-6 animate-in fade-in zoom-in duration-300 max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select value={ruleType} onChange={(e) => setRuleType(e.target.value)}
                                        className="w-full px-4 py-3 rounded-2xl bg-app-surface border-none focus:ring-4 focus:ring-violet-100 outline-none font-bold text-app-foreground appearance-none">
                            ...
                            <div className="p-4 bg-app-surface rounded-2xl space-y-3">
                        ...
                        <div className="flex gap-4 pt-4">
                            <button onClick={() => setShowRuleForm(false)} className="flex-1 px-6 py-3 rounded-2xl font-black text-app-muted-foreground hover:bg-app-surface transition-all text-sm uppercase tracking-widest">Cancel</button>
