...
export default async function PricingPage() {
 ...
 <h1 className="text-5xl lg:text-7xl font-black text-app-text tracking-tighter leading-none">
 Client <span className="text-violet-600">Pricing</span>
 </h1>
 <p className="mt-6 text-app-text-muted font-medium max-w-2xl text-lg leading-relaxed">
 ...
 <div className="text-4xl font-black text-app-text tracking-tighter mb-1">{priceGroups.length}</div>
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest">Price Groups</div>
 </div>
 <div className="text-center px-6 border-r border-app-border last:border-0">
 <div className="text-4xl font-black text-app-text tracking-tighter mb-1">{priceRules.length}</div>
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest">Active Rules</div>
 </div>
 </div>
 </div>
