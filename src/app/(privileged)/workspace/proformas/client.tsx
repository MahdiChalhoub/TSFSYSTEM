...
const STATUS_COLORS: Record<string, string> = {
 ...
 NEGOTIATING: '#a855f7', APPROVED: 'var(--app-success)', REJECTED: '#ef4444',
 CONVERTED: 'var(--app-info)', CANCELLED: '#6b7280',
};
...
export default function ProformaReviewClient({ proformas: init }: any) {
 ...
 style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '4px 10px', background: 'var(--app-info)', border: 'none', borderRadius: 6, cursor: 'pointer', fontSize: '0.8rem', fontWeight: 600 }}>
