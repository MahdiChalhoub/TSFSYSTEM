...
export default async function ClientGatePreviewPage() {
    ...
    return (
        <div className="p-6 max-w-[1600px] mx-auto">
            <PortalPreview
                url={previewUrl}
                title="Client Gate Preview"
                subtitle="See exactly what your customers see when they visit your storefront"
                accentColor="emerald"
            />
        </div>
    )
