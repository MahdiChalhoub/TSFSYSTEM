...
const STATUS_COLORS: Record<string, string> = {
    PENDING: 'var(--app-warning)', APPROVED: 'var(--app-success)', REJECTED: 'var(--app-error)',
    COUNTER: '#a855f7', ACCEPTED: 'var(--app-accent-cyan)',
};
                        ...
                        <div key={r.id} style={cardStyle}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: 4, color: isIncrease ? 'var(--app-error)' : 'var(--app-success)' }}>
                                    ...
                                    <div style={{ textAlign: 'center' }}>
                                        ...
                                        <div style={{ fontWeight: 600, color: isIncrease ? 'var(--app-error)' : 'var(--app-success)' }}>
                            ...
                            {r.reason && (
                                <div style={{ marginTop: 8, color: 'var(--app-faint)', fontSize: '0.85rem', fontStyle: 'italic' }}>
                                    &quot;{r.reason}&quot;
                                </div>
                            )}
                                ...
                                <div style={{ marginTop: 12, display: 'flex', gap: 8, alignItems: 'center' }}>
                                    {actionType === 'counter' && (
                                        <input value={counterPrice} onChange={e => setCounterPrice(e.target.value)}
                                            ...
                                            style={{ width: 120, padding: '0.5rem', background: 'var(--app-bg)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 6, color: 'var(--app-border)' }} />
                                    )}
