    ...
    const columns: ColumnDef<any>[] = useMemo(() => [
        {
            ...
            render: (t) => (
                <div className="flex flex-col">
                    <span className="font-mono text-sm font-black text-gray-900">{t.reference || t.ref_code || `#${t.id}`}</span>
                    <span className="text-[10px] text-gray-400 font-medium truncate max-w-[200px]">{t.title || t.subject || 'Untitled tender'}</span>
                </div>
            )
        },
        {
            ...
            render: (t) => (
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-gray-900 text-sm">{t.client_name || t.contact_name || 'N/A'}</span>
                </div>
            )
        },
        {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="rounded-3xl border-0 shadow-sm bg-white overflow-hidden group">
                    <CardContent className="p-6 flex items-center gap-5">
                        ...
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Total Tenders</p>
                ...
                <Card className="rounded-3xl border-0 shadow-sm bg-white overflow-hidden group">
                    <CardContent className="p-6 flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p className="text-3xl font-black mt-1 tracking-tighter text-gray-900">{stats.open}</p>
                        </div>
                    </CardContent>
                </Card>
                <Card className="rounded-3xl border-0 shadow-sm bg-white overflow-hidden group">
                    <CardContent className="p-6 flex items-center gap-5">
                        ...
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Pipeline Value</p>
