...
export default function CreateKpiConfigPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('workspace/kpi-config/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/workspace/kpi-config'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new kpi config to the system
          </p>
        </div>
      </div>
