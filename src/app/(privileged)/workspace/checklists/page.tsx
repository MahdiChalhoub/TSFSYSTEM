...
export default async function ChecklistsPage() {
 ...
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest group-hover:text-amber-600 transition-colors">Active</div>
 </div>
 ...
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest group-hover:text-indigo-600 transition-colors">Points</div>
 </div>
