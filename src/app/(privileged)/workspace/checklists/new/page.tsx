...
export default function CreateChecklistsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('workspace/checklists/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/workspace/checklists'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new checklists to the system
          </p>
        </div>
      </div>
