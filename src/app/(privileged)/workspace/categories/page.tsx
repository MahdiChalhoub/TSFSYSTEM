...
type Categories = Record<string, any>

const ALL_COLUMNS: ColumnDef<Categories>[] = [
...
export default function CategoriesListPage() {
  ...
  const settings = useListViewSettings('workspace_categories', {
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<Categories>
        ...
        headerExtra={
          <Button
            onClick={() => router.push('/workspace/categories/new')}
        ...
        actions={{
          onView: (r) => router.push(`/workspace/categories/${r.id}`),
          onEdit: (r) => router.push(`/workspace/categories/${r.id}/edit`),
        }}
      >
        <TypicalFilter
