...
export default function CreateEvaluationsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('workspace/evaluations/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/workspace/evaluations'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new evaluations to the system
          </p>
        </div>
      </div>
