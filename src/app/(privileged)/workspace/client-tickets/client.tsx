...
const STATUS_COLORS: Record<string, string> = {
 OPEN: '#ef4444', IN_PROGRESS: 'var(--app-warning)', WAITING_CLIENT: 'var(--app-primary)',
 RESOLVED: 'var(--app-success)', CLOSED: 'var(--app-muted-foreground)',
};
const PRIORITY_COLORS: Record<string, string> = {
 LOW: 'var(--app-muted-foreground)', NORMAL: 'var(--app-info)', HIGH: 'var(--app-warning)', URGENT: '#ef4444',
};
