...
export default function CreateQuestionnairesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('workspace/questionnaires/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/workspace/questionnaires'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new questionnaires to the system
          </p>
        </div>
      </div>
