...
const TRIGGER_EVENTS = [
    ...
    { value: 'YEAR_CLOSING_SOON', label: 'Fiscal Year Closing Soon', group: 'Finance' },
    { value: 'YEAR_STARTING_SOON', label: 'Next Fiscal Year Starting Soon', group: 'Finance' },
    { value: 'CHECKLIST_READY_TO_CLOSE', label: 'Close Checklist Ready (gate cleared)', group: 'Finance' },
    { value: 'CHECKLIST_ITEM_OVERDUE', label: 'Close Checklist Item Overdue', group: 'Finance' },
...
const SMART_DEFAULTS: Record<string, { title?: string; priority?: string; minutes?: number; days_before?: number; require_completion_note?: boolean }> = {
    ...
    YEAR_CLOSING_SOON: { title: 'Prepare year-end close — {reference}', priority: 'HIGH', minutes: 120, days_before: 14, require_completion_note: true },
    YEAR_STARTING_SOON: { title: 'Open new fiscal year — {reference}', priority: 'MEDIUM', minutes: 30, days_before: 7 },
    CHECKLIST_READY_TO_CLOSE: { title: 'Run final close — {reference} checklist is ready', priority: 'HIGH', minutes: 30 },
    CHECKLIST_ITEM_OVERDUE: { title: 'Resolve overdue close-checklist item — {reference}', priority: 'URGENT', minutes: 30, days_before: 3, require_completion_note: true },
