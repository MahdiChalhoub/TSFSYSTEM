...
export default async function TasksPage() {
 ...
 <div className="text-4xl font-black text-app-text tracking-tighter mb-1">{dashboard?.total_assigned ?? 0}</div>
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest group-hover:text-indigo-600 transition-colors">Assigned</div>
 </div>
 ...
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest group-hover:text-amber-600 transition-colors">Pending</div>
 </div>
 ...
 <div className="bg-app-surface p-6 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-50 flex flex-col justify-between relative overflow-hidden group hover:border-sky-100 transition-all duration-300">
 <div className="relative z-10">
 <div className="text-4xl font-black text-sky-600 tracking-tighter mb-1">{dashboard?.in_progress ?? 0}</div>
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest group-hover:text-sky-600 transition-colors">Active</div>
 </div>
 ...
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest group-hover:text-emerald-600 transition-colors">Done</div>
 </div>
 ...
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest group-hover:text-red-600 transition-colors">Overdue</div>
 </div>
