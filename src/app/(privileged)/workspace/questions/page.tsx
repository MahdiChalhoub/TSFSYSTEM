...
const ALL_COLUMNS: ColumnDef<Questions>[] = [
...
export default function QuestionsListPage() {
  ...
  const settings = useListViewSettings('workspace_questions', {
  ...
  async function loadData() {
    try {
      setLoading(true)
      const data = await erpFetch('workspace/questions/')
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<Questions>
        ...
        headerExtra={
          <Button
            onClick={() => router.push('/workspace/questions/new')}
        ...
        actions={{
          onView: (r) => router.push(`/workspace/questions/${r.id}`),
          onEdit: (r) => router.push(`/workspace/questions/${r.id}/edit`),
        }}
      >
        <TypicalFilter
