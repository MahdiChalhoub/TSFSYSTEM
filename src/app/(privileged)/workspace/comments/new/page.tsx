...
export default function CreateCommentsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('workspace/comments/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/workspace/comments'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new comments to the system
          </p>
        </div>
      </div>
