...
const getConfig = (type: string) => EVENT_CONFIG[type] || {
    label: type,
    icon: <Search size={15} className="text-gray-400" />,
        ...
        <td className="p-3 max-w-xs">
            <div className="flex items-start gap-1">
                ...
                <div>
                    ...
                    {expanded && (
                        <pre className="mt-1 text-[10px] bg-gray-100 px-2 py-1 rounded text-gray-500 whitespace-pre-wrap break-all">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden flex flex-col h-full">
            ...
            <div className="px-4 py-3 border-b bg-gray-50/50 flex items-center justify-between gap-4 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        className="text-xs font-bold text-gray-700 bg-gray-100 border-0 rounded-lg px-3 py-1.5 outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
                    >
                    ...
                    <button
                        onClick={loadEvents}
                        disabled={loading}
                        className="p-1.5 rounded-lg bg-gray-100 text-gray-500 hover:bg-indigo-50 hover:text-indigo-600 transition-all"
                        title="Refresh"
                    >
            ...
            <div className="flex-1 overflow-auto">
                <table className="w-full text-left text-sm whitespace-nowrap">
                    <thead className="bg-gray-50 text-gray-500 sticky top-0 uppercase text-[10px] font-bold tracking-wider border-b border-gray-200">
                        <tr>
                        ...
                        {loading ? (
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="p-3 font-mono text-[10px] text-gray-500 tabular-nums">
