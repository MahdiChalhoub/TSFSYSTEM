    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden max-w-4xl">
            <div className="px-6 py-5 border-b bg-gray-50/50">
                <h3 className="text-lg font-bold text-gray-900">Audit Alert Configuration</h3>
                <p className="text-sm text-gray-500 mt-1">Configure which POS events should notify managers or create immediate follow-up tasks.</p>
            </div>
            <div className="p-0">
                            ...
                            return (
                                <tr key={ev.id} className="hover:bg-gray-50 transition-colors">
                                    <td className="px-6 py-4">
                                        <div className="font-semibold text-gray-900">{ev.label}</div>
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        ...
                                        >
                                            <span className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${rule.send_notification ? 'left-5' : 'left-1'}`} />
                                        </button>
                                    </td>
                                    <td className="px-6 py-4 text-center">
                                        <button
                                        ...
                                        >
                                            <span className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${rule.create_task ? 'left-5' : 'left-1'}`} />
                                        </button>
                                    </td>
                                </tr>
                            );
