...
export function OrderActions({ orderId, isLocked: initialLocked, isVerified: initialVerified, fneStatus: initialFneStatus }: OrderActionsProps) {
 ...
 disabled={fneLoading}
 className="flex items-center gap-2 px-6 py-3.5 rounded-2xl font-black transition-all bg-app-primary text-white shadow-lg shadow-emerald-200 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
 >
 {fneLoading ? (
