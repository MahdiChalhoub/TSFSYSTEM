...
export default async function SalesImportPage() {
 ...
 <p className="text-app-text-faint text-sm max-w-xl font-medium leading-relaxed">
 ...
 <span className="text-[10px] text-app-text-muted">Upload</span>
 </div>
 <div className="bg-slate-800/50 backdrop-blur-md p-4 rounded-2xl border border-slate-700/50 flex flex-col items-center justify-center min-w-[100px]">
 <span className="text-2xl text-blue-400">02</span>
 <span className="text-[10px] text-app-text-muted">Map</span>
 </div>
 <div className="bg-slate-800/50 backdrop-blur-md p-4 rounded-2xl border border-slate-700/50 flex flex-col items-center justify-center min-w-[100px]">
 <span className="text-2xl text-purple-400">03</span>
 <span className="text-[10px] text-app-text-muted">Sync</span>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-sm font-black uppercase tracking-tight text-app-text">Format Guide</h3>
 </div>
 ...
 <span className="text-[10px] font-black uppercase text-app-text-faint">{tip.label}</span>
 <span className="text-xs font-medium text-app-text-muted tracking-tight">{tip.desc}</span>
 </li>
 ))}
 </ul>
 </div>
