...
class POSErrorBoundary extends React.Component<{ children: React.ReactNode }, { hasError: boolean; error: string }> {
 ...
 <h2 className="text-xl font-black text-app-text mb-2">POS Error</h2>
 ...
 <p className="text-app-text-faint text-xs mt-4">If this persists, try Ctrl+Shift+R or clear your browser cache.</p>
 </div>
 </div>
 );
 }
...
function POSTerminalInner() {
 ...
 className="flex-1 py-3.5 border-2 border-app-border rounded-2xl text-gray-700 font-bold text-sm hover:bg-app-bg transition-all">
 Cancel
 </button>
