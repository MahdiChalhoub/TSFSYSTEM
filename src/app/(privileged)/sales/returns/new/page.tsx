...
function CreateReturnForm() {
 ...
 if (!order) return <div className="p-20 text-center"><AlertCircle className="mx-auto mb-4 text-app-muted-foreground" size={48} /><p>Order not found</p></div>
 ...
 <textarea
 className="w-full h-32 p-4 rounded-2xl border border-app-border bg-app-surface-2/50 focus:ring-2 focus:ring-rose-200 focus:border-rose-400 transition-all outline-none text-sm"
 ...
 <Button
 className="w-full h-16 rounded-2xl bg-rose-600 hover:bg-rose-700 text-app-foreground font-black text-lg shadow-lg shadow-rose-900/20 flex items-center gap-3 transition-all active:scale-[0.98]"
 ...
 <div className="p-6 bg-app-warning-bg rounded-[2rem] border border-app-warning/30">
