...
function CreateReturnForm() {
 ...
 <div>
 <Link href={`/sales/${orderId}`} className="flex items-center gap-2 text-xs font-bold text-app-text-faint hover:text-rose-500 mb-4 transition-all">
 ...
 <div className="text-[10px] text-app-text-faint uppercase font-mono">Original Line ID: {line.id}</div>
 </TableCell>
 <TableCell className="text-center font-bold text-app-text-muted">{line.quantity}</TableCell>
 <TableCell>
 <Input
 type="number"
 min={0}
 ...
 <h3 className="font-bold text-xs uppercase tracking-widest text-app-text-faint">Return Reason</h3>
 <textarea
 className="w-full h-32 p-4 rounded-2xl border border-app-border bg-gray-50/50 focus:ring-2 focus:ring-rose-200 focus:border-rose-400 transition-all outline-none text-sm"
 ...
 <div className="flex justify-between items-center py-2 border-b border-gray-800">
 <span className="text-sm text-app-text-faint">Total Calculation</span>
