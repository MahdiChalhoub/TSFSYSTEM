                ...
                <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="flex items-center gap-1 px-3 py-1.5 bg-app-success text-white text-xs font-bold rounded-lg hover:bg-app-success transition-colors"
                        >
                            <Plus size={14} /> New
                        </button>
                    </div>
                                ...
                                <div className="flex flex-wrap gap-2 mt-4">
                                    {selected.status === 'DRAFT' && (
                                        <button onClick={() => handleAction('send')} disabled={loading}
                                            className="flex items-center gap-1.5 px-4 py-2 bg-app-info text-white text-xs font-bold rounded-lg hover:bg-app-info disabled:opacity-40">
                                    ...
                                    {['DRAFT', 'SENT'].includes(selected.status) && (
                                        <>
                                            <button onClick={() => handleAction('accept')} disabled={loading}
                                                className="flex items-center gap-1.5 px-4 py-2 bg-app-success text-white text-xs font-bold rounded-lg hover:bg-app-success disabled:opacity-40">
                                                <Check size={14} /> Accept
                                            </button>
                                            <button onClick={() => handleAction('reject')} disabled={loading}
                                                className="flex items-center gap-1.5 px-4 py-2 bg-app-error text-white text-xs font-bold rounded-lg hover:bg-app-error disabled:opacity-40">
                                                <X size={14} /> Reject
                                            </button>
                                        </>
                                    )}
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    {['DRAFT', 'SENT'].includes(selected.status) && (
                                        <button
                                            ...
                                            className="flex items-center gap-1 px-3 py-1.5 bg-app-success text-white text-xs font-bold rounded-lg hover:bg-app-success"
                                        >
