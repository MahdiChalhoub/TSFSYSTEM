...
export default function ConsignmentManager({
 ...
 <thead className="text-xs uppercase bg-gray-50/50 text-app-text-muted font-bold border-b border-app-border">
 <tr>
 ...
 <tr>
 <td colSpan={6} className="px-6 py-12 text-center text-app-text-faint">
 ...
 <div className="font-semibold text-app-text">{inv.product_name}</div>
 <div className="text-xs text-app-text-faint font-mono tracking-tighter uppercase">{inv.sku}</div>
 </td>
 <td className="px-6 py-4 text-app-text-muted">{inv.warehouse_name}</td>
 <td className="px-6 py-4">
 ...
 <td className="px-6 py-4 text-right text-app-text-muted">{Number(inv.consignment_cost).toLocaleString()}</td>
 ...
 <h3 className="text-lg font-bold text-app-text">All Clear!</h3>
 <p className="text-app-text-faint mt-1 max-w-sm mx-auto">All sold items have been settled with suppliers. Check your history for details.</p>
 </CardContent>
 </Card>
 )}
 ...
 className="bg-app-surface text-app-text px-6 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 hover:bg-amber-400 transition-colors disabled:opacity-50"
 >
 ...
 <table className="w-full text-sm text-left">
 <thead className="bg-gray-50/50 text-[10px] uppercase text-app-text-faint font-bold border-b border-app-border">
 <tr>
 ...
 <td className="px-6 py-4">
 <div className="font-semibold text-app-text">{line.product_name}</div>
 <div className="text-[10px] text-app-text-faint uppercase tracking-tighter">Order #{line.order_ref}</div>
 </td>
 <td className="px-6 py-4 text-right font-medium">{line.quantity}</td>
 <td className="px-6 py-4 text-right text-app-text-muted">{Number(Number(line.payout_amount) / (Number(line.quantity) || 1)).toLocaleString()}</td>
 ...
 <div className="col-span-full py-12 text-center text-app-text-faint">
 ...
 <h4 className="font-bold text-app-text">{settle.reference}</h4>
 <p className="text-xs text-app-text-faint mt-1 mb-4 flex items-center">
 <Users size={12} className="mr-1" />
 {settle.supplier_name}
 </p>
 <div className="flex justify-between items-end border-t border-app-border pt-4">
 <div>
 <p className="text-[10px] text-app-text-faint uppercase font-bold tracking-wider">Settlement Total</p>
 <p className="font-black text-lg text-app-text">{Number(settle.total_amount).toLocaleString()} <span className="text-[10px] font-normal">XOF</span></p>
 </div>
 <button className="p-2 text-app-text-faint hover:bg-app-surface hover:shadow-sm hover:text-app-text rounded-lg transition-all">
 <Printer size={18} />
 </button>
 </div>
 </div>
