...
export default function ConsignmentManager({
 ...
 <Card className="bg-gradient-to-br from-indigo-500 to-indigo-600 text-app-foreground border-none shadow-lg">
 <CardContent className="p-6">
 <div className="flex justify-between items-start">
 <div>
 <p className="text-app-foreground/80 text-sm font-medium">In-Stock Consignment</p>
 <h3 className="text-3xl font-bold mt-1">{totalConsignmentValue.toLocaleString()} <span className="text-sm font-normal text-app-foreground/70">XOF</span></h3>
 </div>
 <div className="bg-app-foreground/20 p-2 rounded-lg">
 <Package size={24} />
 </div>
 </div>
 <div className="mt-4 flex items-center text-sm text-app-foreground/80">
 ...
 <Card className="bg-gradient-to-br from-amber-500 to-orange-500 text-app-foreground border-none shadow-lg">
 <CardContent className="p-6">
 <div className="flex justify-between items-start">
 <div>
 <p className="text-app-foreground/80 text-sm font-medium">Pending Payouts</p>
 <h3 className="text-3xl font-bold mt-1">{totalPendingPayout.toLocaleString()} <span className="text-sm font-normal text-app-foreground/70">XOF</span></h3>
 </div>
 <div className="bg-app-foreground/20 p-2 rounded-lg">
 <DollarSign size={24} />
 </div>
 ...
 <Card className="bg-gradient-to-br from-emerald-500 to-teal-500 text-app-foreground border-none shadow-lg">
 <CardContent className="p-6">
 <div className="flex justify-between items-start">
 <div>
 <p className="text-app-foreground/80 text-sm font-medium">Completed Settlements</p>
 ...
 <Box className="text-app-primary" />
 ...
 <thead className="text-xs uppercase bg-app-surface-2/50 text-app-muted-foreground font-bold border-b border-app-border">
 <tr>
 ...
 <tr key={inv.id} className="hover:bg-app-surface-2/30 transition-colors">
 ...
 <td className="px-6 py-4">
 <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-app-primary/5 text-app-primary">
 ...
 <div className="bg-gradient-to-r from-gray-900 to-gray-800 p-6 flex justify-between items-center text-app-foreground">
 <div>
 <div className="flex items-center gap-2">
 <Users size={20} className="text-app-warning" />
 <h3 className="text-lg font-bold">{supplier.name}</h3>
 </div>
 <p className="text-app-foreground/60 text-sm mt-1">{supplier.items.length} items sold • {supplier.total.toLocaleString()} XOF pending</p>
 </div>
 <button
 ...
 className="bg-app-surface text-app-foreground px-6 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 hover:bg-app-warning/10 transition-colors disabled:opacity-50"
 >
 ...
 <table className="w-full text-sm text-left">
 <thead className="bg-app-surface-2/50 text-[10px] uppercase text-app-muted-foreground font-bold border-b border-app-border">
 <tr>
 ...
 <tr key={line.id} className="hover:bg-app-surface-2/20">
 <td className="px-6 py-4">
 <input
 type="checkbox"
 ...
 <td className="px-6 py-4 text-right font-bold text-app-primary">{Number(line.payout_amount).toLocaleString()}</td>
 </tr>
 ))}
 </tbody>
 </table>
 ...
 <CardHeader>
 <CardTitle className="text-lg flex items-center gap-2">
 <History className="text-app-primary" />
 Settlement Archive
 </CardTitle>
 </CardHeader>
 <CardContent>
 ...
 <div key={settle.id} className="bg-app-surface-2/50 border border-app-border rounded-2xl p-5 hover:border-app-success hover:bg-app-primary-light/10 transition-all group">
 <div className="flex justify-between items-start mb-4">
 <div className="bg-app-surface p-2.5 rounded-xl shadow-sm group-hover:bg-app-primary group-hover:text-app-foreground transition-colors">
 <FileText size={20} />
 </div>
 <span className={`px-2 py-1 rounded text-[10px] font-bold uppercase ${settle.status === 'PAID' ? 'bg-app-primary-light text-app-success' : 'bg-app-warning-bg text-app-warning'
 }`}>
 {settle.status}
 </span>
 </div>
