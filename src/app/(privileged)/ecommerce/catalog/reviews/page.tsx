...
export default function ReviewManagementPage() {
    ...
    const loadReviews = useCallback(async () => {
        setLoading(true)
        try {
            const res = await erpFetch('/client_portal/reviews/')
            const data = res
    ...
    const toggleVisibility = async (review: any) => {
        try {
            const res = await erpFetch(`/client_portal/reviews/${review.id}/`, {
                method: 'PATCH',
    ...
    const deleteReview = async (id: string) => {
        ...
        try {
            await erpFetch(`/client_portal/reviews/${id}/`, { method: 'DELETE' })
            loadReviews()
        } catch (err) { console.error(err) }
    }
