        ...
        <div className="app-page">
            ...
            <div className="app-page-header">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: '#64748b' }}>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
                {[
                    { label: 'Endpoints', value: hooks.length, icon: Globe, color: '#64748b' },
                    { label: 'Active', value: active, icon: CheckCircle, color: '#10b981' },
                    { label: 'Event Types Available', value: supportedEvents.length, icon: Activity, color: '#06b6d4' },
                ...
                {hooks.length === 0 ? (
                    <div className="py-16 flex flex-col items-center gap-3">
                        <div className="w-12 h-12 rounded-2xl flex items-center justify-center" style={{ background: '#64748b18' }}>
                            <WebhookIcon size={22} style={{ color: '#64748b' }} />
                        </div>
                        ...
                        {hooks.map(h => (
                            <div key={h.id} className="flex items-start gap-4 px-5 py-4 hover:bg-[var(--app-surface-hover)] transition-colors">
                                <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5"
                                    ...
                                    <Globe size={14} style={{ color: h.is_active ? '#10b981' : 'var(--app-text-muted)' }} />
                                </div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="app-card w-full max-w-md space-y-5">
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0" style={{ background: '#64748b' }}>
