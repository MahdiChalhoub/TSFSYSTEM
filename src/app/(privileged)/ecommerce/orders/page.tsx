        ...
        <div className="min-h-screen bg-[#070D1B] text-gray-100 p-6 flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-white tracking-tight">Online Orders</h1>
                        <p className="text-sm text-gray-400 mt-0.5">Manage eCommerce orders from your storefront</p>
                    </div>
                </div>
