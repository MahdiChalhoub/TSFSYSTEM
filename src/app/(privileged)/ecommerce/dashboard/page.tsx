...
export default function EcommerceDashboardPage() {
 ...
 <h2 className="text-4xl font-black text-white tracking-tighter mt-1">{deliveredCount} <span className="text-sm font-black text-app-text-muted uppercase tracking-widest">UNITS</span></h2>
