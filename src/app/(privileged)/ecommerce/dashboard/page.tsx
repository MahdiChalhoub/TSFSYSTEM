...
export default function EcommerceDashboardPage() {
 ...
 <div className="h-12 w-64 bg-app-surface-2 rounded-2xl" />
 <div className="grid grid-cols-4 gap-6">
 {[1, 2, 3, 4].map(i => <div key={i} className="h-32 bg-app-bg rounded-[2.5rem]" />)}
 </div>
 <div className="h-96 bg-app-bg rounded-[2.5rem]" />
 </div>
 )
 }
 return (
 ...
 <Store size={40} className="text-app-text fill-white/20" />
 </div>
 <div>
 ...
 <button onClick={load} className="h-14 px-8 rounded-2xl bg-app-surface border border-app-border shadow-[0_8px_30px_rgb(0,0,0,0.04)] font-black text-[11px] uppercase tracking-widest text-app-text-muted flex items-center gap-3 hover:bg-app-bg transition-all active:scale-95">
 ...
 <p className="text-[11px] font-black text-app-text-faint uppercase tracking-widest leading-none mb-1">Total Recent Orders</p>
 <h2 className="text-4xl font-black text-app-text tracking-tighter mt-1">{recent.length}</h2>
 ...
 <p className="text-[11px] font-black text-app-text-faint uppercase tracking-widest leading-none mb-1">Recent Revenue</p>
 <h2 className="text-4xl font-black text-app-text tracking-tighter mt-1">${totalRevenue.toFixed(0)}</h2>
 <div className="mt-6 pt-5 border-t border-slate-50 flex items-center gap-3 text-[10px] font-black text-app-text-faint uppercase tracking-tight">
 <ShieldCheck size={14} className="text-emerald-500" /> Settled: Global
 </div>
 </div>
 <div className="rounded-[2.5rem] bg-slate-900 border-0 shadow-2xl shadow-slate-900/30 overflow-hidden group hover:scale-[1.02] transition-all duration-500 relative p-8 text-app-text">
 ...
 <p className="text-[11px] font-black text-app-text-faint uppercase tracking-widest leading-none mb-1">Fulfillment Rate</p>
 <h2 className="text-4xl font-black text-app-text tracking-tighter mt-1">{deliveredCount} <span className="text-sm font-black text-app-text-muted uppercase tracking-widest">UNITS</span></h2>
 ...
 <Badge variant="outline" className="text-app-text-faint bg-app-bg border-app-border font-black text-[10px] px-3 py-1 rounded-full">
 LOGISTICS
 </Badge>
 </div>
 <p className="text-[11px] font-black text-app-text-faint uppercase tracking-widest leading-none mb-1">Active Deliveries</p>
 <h2 className="text-4xl font-black text-app-text tracking-tighter mt-1">{recent.filter(o => o.status === 'SHIPPED').length}</h2>
 <div className="mt-6 pt-5 border-t border-slate-50 flex items-center gap-3 text-[10px] font-black text-app-text-faint uppercase tracking-tight">
 ...
 <div className="lg:col-span-1 bg-app-surface p-8 rounded-[2.5rem] shadow-sm flex flex-col gap-6">
 <div>
 <p className="text-[10px] font-black text-app-text-faint uppercase tracking-widest mb-1">Logistics Pipeline</p>
 <h3 className="text-xl font-black text-app-text uppercase italic">Conversion <span className="text-indigo-600">Funnel</span></h3>
 </div>
 ...
 <span className="text-lg font-black text-app-text">{count}</span>
 </div>
 <div className="h-2 w-full bg-app-bg rounded-full overflow-hidden border border-gray-100/50">
 <div
 ...
 <div className="lg:col-span-2 bg-app-surface rounded-[2.5rem] shadow-sm overflow-hidden border-2 border-slate-50">
 <div className="px-8 py-7 border-b border-gray-50 flex items-center justify-between">
 <div>
 <p className="text-[10px] font-black text-app-text-faint uppercase tracking-widest mb-1">Transaction Node</p>
 <h3 className="text-xl font-black text-app-text uppercase italic">Recent <span className="text-indigo-600">Operations</span></h3>
 </div>
