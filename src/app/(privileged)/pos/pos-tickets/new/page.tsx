...
export default function CreatePosTicketsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('pos/pos-tickets/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/pos/pos-tickets'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new pos tickets to the system
          </p>
        </div>
      </div>
