...
const ALL_COLUMNS: ColumnDef<Purchase>[] = [
...
export default function PurchaseListPage() {
  ...
  const settings = useListViewSettings('pos_purchase', {
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<Purchase>
        ...
        headerExtra={
          <Button
            onClick={() => router.push('/pos/purchase/new')}
        ...
        actions={{
          onView: (r) => router.push(`/pos/purchase/${r.id}`),
          onEdit: (r) => router.push(`/pos/purchase/${r.id}/edit`),
        }}
      >
        <TypicalFilter
