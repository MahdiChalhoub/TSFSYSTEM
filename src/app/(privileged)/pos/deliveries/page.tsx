...
type Deliveries = Record<string, any>

const ALL_COLUMNS: ColumnDef<Deliveries>[] = [
...
export default function DeliveriesListPage() {
  ...
  const settings = useListViewSettings('pos_deliveries', {
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<Deliveries>
        ...
        headerExtra={
          <Button
            onClick={() => router.push('/pos/deliveries/new')}
        ...
        actions={{
          onView: (r) => router.push(`/pos/deliveries/${r.id}`),
          onEdit: (r) => router.push(`/pos/deliveries/${r.id}/edit`),
        }}
      >
        <TypicalFilter
