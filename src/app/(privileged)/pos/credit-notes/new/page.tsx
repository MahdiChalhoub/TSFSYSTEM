...
export default function CreateCreditNotesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('pos/credit-notes/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/pos/credit-notes'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new credit notes to the system
          </p>
        </div>
      </div>
