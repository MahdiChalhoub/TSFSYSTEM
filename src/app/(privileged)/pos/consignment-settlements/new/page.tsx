...
export default function CreateConsignmentSettlementsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('pos/consignment-settlements/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/pos/consignment-settlements'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          <h1 className="text-3xl md:text-4xl font-black theme-text">
            Create Consignment Settlements
          </h1>
          <p className="theme-text-muted mt-1">
            Add a new consignment settlements to the system
          </p>
        </div>
      </div>
