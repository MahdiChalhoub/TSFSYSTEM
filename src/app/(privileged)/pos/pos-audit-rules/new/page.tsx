...
export default function CreatePosAuditRulesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('pos/pos-audit-rules/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/pos/pos-audit-rules'), 500)
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen layout-container-padding bg-app-bg">
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          <h1>
            Create Pos Audit Rules
          </h1>
          <p className="text-app-muted-foreground mt-1">
            Add a new pos audit rules to the system
          </p>
        </div>
      </div>
