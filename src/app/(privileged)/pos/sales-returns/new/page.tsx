...
export default function CreateSalesReturnsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('pos/sales-returns/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/pos/sales-returns'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new sales returns to the system
          </p>
        </div>
      </div>
