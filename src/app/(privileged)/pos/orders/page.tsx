...
const ALL_COLUMNS: ColumnDef<Orders>[] = [
...
export default function OrdersListPage() {
  ...
  const settings = useListViewSettings('pos_orders', {
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<Orders>
        ...
        actions={{
          onView: (r) => router.push(`/pos/orders/${r.id}`),
          onEdit: (r) => router.push(`/pos/orders/${r.id}/edit`),
        }}
      >
        <TypicalFilter
