...
export default function CreatePosRegistersPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('pos/pos-registers/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/pos/pos-registers'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          <h1 className="text-3xl md:text-4xl font-black theme-text">
            Create Pos Registers
          </h1>
          <p className="theme-text-muted mt-1">
            Add a new pos registers to the system
          </p>
        </div>
      </div>
