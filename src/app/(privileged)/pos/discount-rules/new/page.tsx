...
export default function CreateDiscountRulesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('pos/discount-rules/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/pos/discount-rules'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new discount rules to the system
          </p>
        </div>
      </div>
