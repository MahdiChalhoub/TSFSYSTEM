...
export default function CreateDeliveryZonesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('pos/delivery-zones/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/pos/delivery-zones'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new delivery zones to the system
          </p>
        </div>
      </div>
