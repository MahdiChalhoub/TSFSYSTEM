...
export default function CreatePosAuditEventsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('pos/pos-audit-events/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/pos/pos-audit-events'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          <h1 className="text-3xl md:text-4xl font-black text-app-foreground">
            Create Pos Audit Events
          </h1>
          <p className="text-app-muted-foreground mt-1">
            Add a new pos audit events to the system
          </p>
        </div>
      </div>
