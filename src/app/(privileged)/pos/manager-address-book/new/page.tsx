...
export default function CreateManagerAddressBookPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('pos/manager-address-book/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/pos/manager-address-book'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new manager address book to the system
          </p>
        </div>
      </div>
