...
const ALL_COLUMNS: ColumnDef<Providers>[] = [
...
export default function ProvidersListPage() {
  ...
  const settings = useListViewSettings('mcp_providers', {
  ...
  async function loadData() {
    try {
      setLoading(true)
      const data = await erpFetch('mcp/providers/')
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<Providers>
        ...
        headerExtra={
          <Button
            onClick={() => router.push('/mcp/providers/new')}
        ...
        actions={{
          onView: (r) => router.push(`/mcp/providers/${r.id}`),
          onEdit: (r) => router.push(`/mcp/providers/${r.id}/edit`),
        }}
      >
        <TypicalFilter
