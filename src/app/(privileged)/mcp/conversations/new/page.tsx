...
export default function CreateConversationsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('mcp/conversations/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/mcp/conversations'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new conversations to the system
          </p>
        </div>
      </div>
