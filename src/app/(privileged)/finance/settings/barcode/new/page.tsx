...
export default function CreateBarcodeSettingsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/settings/barcode/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/settings/barcode'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          <h1 className="text-3xl md:text-4xl font-black text-app-foreground">
            Create BarcodeSettings
          </h1>
          <p className="text-app-muted-foreground mt-1">
            Add a new settings/barcode to the system
          </p>
        </div>
      </div>
