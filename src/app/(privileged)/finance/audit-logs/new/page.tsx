...
export default function CreateAuditLogsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/audit-logs/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/audit-logs'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new audit logs to the system
          </p>
        </div>
      </div>
