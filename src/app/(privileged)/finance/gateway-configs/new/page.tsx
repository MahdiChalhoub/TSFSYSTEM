...
export default function CreateGatewayConfigsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/gateway-configs/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/gateway-configs'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new gateway configs to the system
          </p>
        </div>
      </div>
