...
export default function CreateCounterpartyTaxProfilesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/counterparty-tax-profiles/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/counterparty-tax-profiles'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          <h1 className="text-3xl md:text-4xl font-black theme-text">
            Create Counterparty Tax Profiles
          </h1>
          <p className="theme-text-muted mt-1">
            Add a new counterparty tax profiles to the system
          </p>
        </div>
      </div>
