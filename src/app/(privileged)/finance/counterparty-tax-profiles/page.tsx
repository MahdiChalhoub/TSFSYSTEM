...
type CounterpartyTaxProfiles = Record<string, any>

const ALL_COLUMNS: ColumnDef<CounterpartyTaxProfiles>[] = [
  { key: 'id', label: 'ID', sortable: true }
]

export default function CounterpartyTaxProfilesListPage() {
  const router = useRouter()
  const [items, setItems] = useState<CounterpartyTaxProfiles[]>([])
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<CounterpartyTaxProfiles>
        ...
        actions={{
          ...
          onEdit: (r) => router.push(`/finance/counterparty-tax-profiles/${r.id}/edit`),
        }}
      >
        <TypicalFilter
