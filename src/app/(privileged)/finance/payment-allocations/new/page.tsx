...
export default function CreatePaymentAllocationsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/payment-allocations/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/payment-allocations'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new payment allocations to the system
          </p>
        </div>
      </div>
