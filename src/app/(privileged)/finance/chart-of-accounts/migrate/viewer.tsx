...
export default function CoaMigrationTool({
 ...
 <p className="text-app-text-faint text-xs font-bold uppercase tracking-widest mt-1">Select the standard you want to migrate to</p>
 </div>
 </div>
 </div>
 ...
 <p className="text-xs text-app-text-muted mt-1">Standard structural hierarchy and account codes.</p>
 </div>
 </button>
 ))}
 </div>
 ...
 <thead>
 <tr className="bg-stone-900 text-app-text-faint uppercase text-[10px] tracking-widest font-bold">
 ...
 <div className="text-[10px] font-bold text-app-text-faint uppercase tracking-tighter mb-1 font-mono">{acc.code}</div>
 <div className="font-bold text-app-text">{acc.name}</div>
 <div className="mt-1 flex items-center gap-2">
 <span className="text-[10px] font-black bg-app-surface-2 text-app-text-muted px-1.5 py-0.5 rounded">{acc.type}</span>
 ...
 <td className="p-5">
 <select
 className="w-full p-3.5 rounded-2xl border border-app-border text-sm font-medium focus:ring-4 focus:ring-amber-500/10 focus:border-amber-500 outline-none transition-all shadow-sm bg-stone-50/30"
 ...
 <div className="p-20 text-center text-app-text-faint italic">
 ...
 {/* Footer Actions */}
 <div className="flex justify-between items-center bg-app-bg p-6 rounded-3xl border border-app-border shadow-inner">
 <button
 disabled={isPending}
 onClick={() => setStep(1)}
 className="px-8 py-3 rounded-xl font-bold text-app-text-muted hover:text-app-text transition-all flex items-center gap-2"
 >
 ...
 <p className="text-[10px] text-app-text-faint font-bold text-center uppercase tracking-widest">
