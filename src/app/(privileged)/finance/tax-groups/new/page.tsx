...
export default function CreateTaxGroupsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/tax-groups/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/tax-groups'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new tax groups to the system
          </p>
        </div>
      </div>
