...
export default function CreateFinancialEventsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/financial-events/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/financial-events'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new financial events to the system
          </p>
        </div>
      </div>
