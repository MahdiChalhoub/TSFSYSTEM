...
export default function ProfitCentersPage() {
 ...
 <p className="text-sm font-medium text-app-text-faint mt-2 uppercase tracking-widest">Departmental Tracking</p>
 </header>
 ...
 <div>
 <p className="text-xs text-app-text-muted uppercase">Centers</p>
 <p className="text-2xl font-bold">{centers.length}</p>
 <p className="text-[10px] text-app-text-faint">{accounts.length} accounts</p>
 </div>
 </div>
 </CardContent>
 </Card>
 ...
 <div>
 <p className="text-xs text-app-text-muted uppercase">Total Debits</p>
 ...
 <div>
 <p className="text-xs text-app-text-muted uppercase">Total Credits</p>
 ...
 <div>
 <p className="text-xs text-app-text-muted uppercase">Net Position</p>
 ...
 <p className="text-[10px] text-app-text-muted uppercase">Debit</p>
 <p className="text-sm font-bold text-green-600">{fmt(c.income)}</p>
 </div>
 <div className="text-center p-2 bg-red-50 rounded-lg">
 <p className="text-[10px] text-app-text-muted uppercase">Credit</p>
 ...
 <p className="text-[10px] text-app-text-muted uppercase">Net</p>
 ...
 <span className="font-mono text-app-text-faint w-14">{a.code}</span>
