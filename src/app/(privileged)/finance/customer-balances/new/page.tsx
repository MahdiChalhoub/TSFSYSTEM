...
export default function CreateCustomerBalancesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/customer-balances/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/customer-balances'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new customer balances to the system
          </p>
        </div>
      </div>
