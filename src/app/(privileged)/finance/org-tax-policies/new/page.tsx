...
export default function CreateOrgTaxPoliciesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/org-tax-policies'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          <h1 className="text-3xl md:text-4xl font-black theme-text">
            Create Org Tax Policies
          </h1>
          <p className="theme-text-muted mt-1">
            Add a new org tax policies to the system
          </p>
        </div>
      </div>
