...
export default function CreateProfitDistributionPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/profit-distribution/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/profit-distribution'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new profit distribution to the system
          </p>
        </div>
      </div>
