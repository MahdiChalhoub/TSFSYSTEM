...
export default function CreateDeferredExpensesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/deferred-expenses/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/deferred-expenses'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          <h1 className="text-3xl md:text-4xl font-black text-app-foreground">
            Create Deferred Expenses
          </h1>
          <p className="text-app-muted-foreground mt-1">
            Add a new deferred expenses to the system
          </p>
        </div>
      </div>
