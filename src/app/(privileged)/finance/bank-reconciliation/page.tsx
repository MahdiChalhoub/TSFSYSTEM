...
export default function BankReconciliationPage() {
 ...
 <span className="font-bold text-app-text">{acc.name}</span>
 </div>
 )
 },
 {
 ...
 label: 'Activity',
 align: 'center',
 render: (acc) => <span className="text-[10px] text-app-text-faint font-bold uppercase">{acc.entry_count} Entries</span>
 },
 {
 key: 'book_balance',
 ...
 <p className="text-sm font-medium text-app-text-faint mt-1 uppercase tracking-widest">Match-Maker Studio</p>
 </div>
 </div>
 <div className="flex items-center gap-3">
 <Button
 ...
 <span className="text-[10px] font-black text-app-text-faint tracking-tighter uppercase ml-2">Select one statement line</span>
 <Button
 variant="ghost"
 size="sm"
 ...
 className={`cursor-pointer transition-all ${isSelected ? 'bg-blue-50 hover:bg-blue-50 border-l-4 border-l-blue-600' : 'hover:bg-app-bg'}`}
 >
 <TableCell className="py-4">
 <div className="flex flex-col">
 <span className="text-[10px] font-black text-app-text-faint mb-1">{e.date}</span>
 <span className="text-xs font-bold text-app-text line-clamp-1">{e.description}</span>
 ...
 <div className="flex-1 bg-app-surface rounded-3xl border border-indigo-100 shadow-md shadow-indigo-50/50 overflow-hidden flex flex-col">
 ...
 <Badge variant="outline" className="h-7 border-indigo-200 bg-app-surface text-indigo-600 font-black text-[10px]">
 ...
 className={`cursor-pointer transition-all ${isSelected ? 'bg-indigo-50 hover:bg-indigo-50 border-l-4 border-l-indigo-600' : 'hover:bg-app-bg'}`}
 >
 <TableCell className="py-4">
 <div className="flex items-center gap-3">
 <div className={`w-2 h-2 rounded-full ${isSelected ? 'bg-indigo-600 scale-125' : 'bg-stone-200'} transition-all`} />
 <div className="flex flex-col">
 <span className="text-[10px] font-black text-app-text-faint mb-1 leading-none">{e.date}</span>
 <p className="text-xs font-bold text-app-text leading-tight">{e.description}</p>
 </div>
 </div>
 </TableCell>
 <TableCell className="text-right align-middle">
 ...
 <p className="text-app-text-faint text-[9px] font-black uppercase tracking-widest">Discrepancy Gap</p>
 <p className="text-emerald-400 text-2xl font-black tracking-tighter">$0.00</p>
 </div>
 <Button onClick={goBack} className="h-12 px-8 rounded-2xl bg-app-surface hover:bg-app-surface-2 text-black font-black text-xs uppercase tracking-widest shadow-xl">
 Finish Settlement
 </Button>
 </div>
 </div>
 ...
 <p className="text-sm font-medium text-app-text-faint mt-2 uppercase tracking-widest">Bank & Cash Reconciliation Engine</p>
 </div>
 ...
 headerExtra={
 <Button onClick={loadAccounts} variant="ghost" className="h-8 w-8 p-0 text-app-text-faint hover:text-blue-600">
