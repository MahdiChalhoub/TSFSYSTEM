...
export default function CreateInvoiceLinesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/invoice-lines/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/invoice-lines'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new invoice lines to the system
          </p>
        </div>
      </div>
