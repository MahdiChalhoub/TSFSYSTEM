...
export default function PriceListManager({ priceLists }: { priceLists: Record<string, any>[] }) {
 ...
 <button type="submit" className="bg-app-background text-app-foreground px-4 py-2 rounded shrink-0" suppressHydrationWarning={true}>Create</button>
 </form>
 </div>
 ...
 <thead className="bg-app-background text-app-muted-foreground font-medium">
 <tr>
 ...
 {priceLists.map(list => (
 <tr key={list.id} className="hover:bg-app-background">
