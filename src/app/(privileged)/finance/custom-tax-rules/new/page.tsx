...
export default function CreateCustomTaxRulesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/custom-tax-rules/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/custom-tax-rules'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new custom tax rules to the system
          </p>
        </div>
      </div>
