...
type CustomTaxRules = Record<string, any>

const ALL_COLUMNS: ColumnDef<CustomTaxRules>[] = [
  { key: 'id', label: 'ID', sortable: true }
]

export default function CustomTaxRulesListPage() {
  const router = useRouter()
  const [items, setItems] = useState<CustomTaxRules[]>([])
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<CustomTaxRules>
        ...
        actions={{
          ...
          onEdit: (r) => router.push(`/finance/custom-tax-rules/${r.id}/edit`),
        }}
      >
        <TypicalFilter
