...
export default function CreateSupplierBalancesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/supplier-balances/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/supplier-balances'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new supplier balances to the system
          </p>
        </div>
      </div>
