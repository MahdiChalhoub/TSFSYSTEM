...
export default function CreatePeriodicTaxPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/periodic-tax/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/periodic-tax'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new periodic tax to the system
          </p>
        </div>
      </div>
