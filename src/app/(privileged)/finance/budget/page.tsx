...
export default function BudgetPlanningPage() {
 ...
 label: 'Code',
 sortable: true,
 render: (a) => <span className="font-mono text-xs text-app-text-muted">{a.code}</span>
 },
 {
 key: 'name',
 label: 'Account Name',
 ...
 <p className="text-sm font-medium text-app-text-faint mt-2 uppercase tracking-widest">Financial Planning & Variance Tracking</p>
 </div>
 ...
 <div className="flex-1 flex items-center justify-center text-[10px] text-app-text-faint uppercase font-bold">No Data Available</div>
 )}
 </div>
 </CardContent>
 </Card>
