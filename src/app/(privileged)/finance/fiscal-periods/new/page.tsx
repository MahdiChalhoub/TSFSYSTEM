...
export default function CreateFiscalPeriodsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/fiscal-periods/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/fiscal-periods'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new fiscal periods to the system
          </p>
        </div>
      </div>
