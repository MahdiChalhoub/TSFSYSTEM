...
export default function AuditTrailPage() {
 ...
 key: 'object_id',
 label: 'Object ID',
 render: (log) => <span className="font-mono text-[10px] text-app-text-faint">ID:{log.object_id}</span>
 },
 {
 key: 'actor',
 label: 'Performed By',
 ...
 <span className="text-sm font-medium text-app-text-muted truncate max-w-[120px]">
 ...
 <p className="text-[10px] font-black text-app-text-faint uppercase tracking-widest mb-1">Total Logs</p>
 <div className="flex items-center gap-3">
 <History size={18} className="text-emerald-500" />
 <span className="text-2xl font-black text-app-text tracking-tighter">{data.count || 0}</span>
 </div>
 </div>
 </div>
 </header>
 ...
 expandable={{
 render: (log) => (
 <div className="p-8 bg-slate-50/50 backdrop-blur-md border-y border-app-border overflow-hidden">
 ...
 <div className="flex flex-col">
 <h4 className="text-xs font-black uppercase tracking-widest text-app-text">Forensic Data Payload</h4>
 <p className="text-[10px] font-bold text-app-text-faint mt-1 uppercase tracking-tighter italic">Immutable Object State Snapshot</p>
 </div>
 </div>
 ...
 headerExtra={
 <div className="flex items-center gap-4">
 <div className="flex bg-app-bg p-1 rounded-2xl border border-app-border shadow-inner px-2">
 <div className="flex items-center gap-2 px-3 py-2">
 <Filter size={14} className="text-app-text-faint" />
 <select
 value={filterAction}
 onChange={e => { setFilterAction(e.target.value); setPage(1) }}
 className="bg-transparent border-none text-[11px] font-black uppercase tracking-widest text-app-text-muted focus:ring-0 outline-none cursor-pointer"
 >
 ...
 <div className="flex items-center gap-2 px-3 py-2">
 <Shield size={14} className="text-app-text-faint" />
 <select
 value={filterModel}
