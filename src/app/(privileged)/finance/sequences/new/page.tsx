...
export default function CreateSequencesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/sequences/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/sequences'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new sequences to the system
          </p>
        </div>
      </div>
