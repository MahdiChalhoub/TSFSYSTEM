...
export default function CreateVatSettlementPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/vat-settlement/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/vat-settlement'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new vat settlement to the system
          </p>
        </div>
      </div>
