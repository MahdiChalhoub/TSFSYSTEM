        ...
        <div className="page-container">
            ...
            <Card className="border-dashed border-2 border-gray-200">
                <CardContent className="py-4 flex flex-wrap items-end gap-4">
                    ...
                    <div className="w-64">
                        <label className="text-xs text-gray-500 uppercase font-semibold mb-1 block">Bank / Settlement Account</label>
                        ...
                        <Card className="border-l-4 border-emerald-500 bg-gradient-to-r from-emerald-50 to-white">
                            <CardContent className="py-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[11px] text-gray-500 uppercase font-semibold">TVA Collectée</p>
                        ...
                        <Card className="border-l-4 border-blue-500 bg-gradient-to-r from-blue-50 to-white">
                            <CardContent className="py-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[11px] text-gray-500 uppercase font-semibold">TVA Récupérable</p>
                        ...
                        <Card className={`border-l-4 ${isRefund ? 'border-amber-400 bg-gradient-to-r from-amber-50 to-white' : 'border-rose-500 bg-gradient-to-r from-rose-50 to-white'}`}>
                            <CardContent className="py-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[11px] text-gray-500 uppercase font-semibold">Net Due</p>
                                        <p className={`text-xl font-black ${isRefund ? 'text-amber-700' : 'text-rose-700'}`}>{fmt(Math.abs(netDue))}</p>
                                        <p className="text-[10px] text-gray-400">{isRefund ? 'Refund ← from state' : 'Payable → to state'}</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
            ...
            <Card>
                <CardHeader className="py-3 flex flex-row items-center justify-between">
                    <CardTitle className="text-sm flex items-center gap-2">
                        <Clock size={16} className="text-gray-400" /> Periodic Tax Accrual
                    </CardTitle>
                    <Button
                        size="sm"
                        variant="outline"
                    ...
                    {accruals.length === 0 ? (
                        ...
                        <table className="w-full text-sm">
                            <thead className="bg-gray-50 border-b">
                                <tr>
                                    <th className="text-left px-4 py-2 font-semibold text-gray-600">Period</th>
                                    <th className="text-left px-4 py-2 font-semibold text-gray-600">Type</th>
                                    <th className="text-right px-4 py-2 font-semibold text-gray-600">Base</th>
