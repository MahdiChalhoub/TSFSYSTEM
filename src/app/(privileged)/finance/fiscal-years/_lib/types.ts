...
export interface UseFiscalYearsReturn {
    ...
    yearTab: Record<number, 'periods' | 'summary' | 'checklist' | 'history' | 'entries' | 'snapshots' | 'integrity'>
    setYearTab: React.Dispatch<React.SetStateAction<Record<number, 'periods' | 'summary' | 'checklist' | 'history' | 'entries' | 'snapshots' | 'integrity'>>>
