...
export default function CreateFiscalYearsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('finance/fiscal-years/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/finance/fiscal-years'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new fiscal years to the system
          </p>
        </div>
      </div>
