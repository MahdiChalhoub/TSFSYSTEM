                        ...
                        {validDates && (
                            <div className="mt-3 pt-3 flex items-center justify-between" style={{ borderTop: '1px solid color-mix(in srgb, var(--app-info, #3b82f6) 20%, transparent)' }}>
                                ...
                                <span className="text-[12px] font-black" style={{ color: 'var(--app-info, #3b82f6)' }}>
                                    ...
                                    {data.includeAuditPeriod && <span className="text-[10px] font-bold ml-1" style={{ color: 'var(--app-muted-foreground)' }}>({baseCount} + 1 audit)</span>}
                                </span>
                            </div>
                        )}
                    </div>
                    <div className="flex gap-2 pt-1">
                        <button type="button" onClick={onClose} className="flex-1 py-2 text-[11px] font-bold rounded-xl border transition-all" style={{ color: 'var(--app-muted-foreground)', borderColor: 'var(--app-border)' }}>Cancel</button>
