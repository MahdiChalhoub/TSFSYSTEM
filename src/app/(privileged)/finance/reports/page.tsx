...
type Reports = Record<string, any>

const ALL_COLUMNS: ColumnDef<Reports>[] = [
...
export default function ReportsListPage() {
  ...
  const settings = useListViewSettings('finance_reports', {
  ...
  async function loadData() {
    try {
      setLoading(true)
      const data = await erpFetch('finance/reports/')
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<Reports>
        ...
        headerExtra={
          <Button
            onClick={() => router.push('/finance/reports/new')}
        ...
        actions={{
          onView: (r) => router.push(`/finance/reports/${r.id}`),
          onEdit: (r) => router.push(`/finance/reports/${r.id}/edit`),
        }}
      >
        <TypicalFilter
