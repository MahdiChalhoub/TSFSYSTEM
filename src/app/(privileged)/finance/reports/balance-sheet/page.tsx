...
export default async function BalanceSheetPage() {
 ...
 <h1 className="page-header-title text-app-text font-serif mb-2">Balance Sheet</h1>
 <p className="text-app-text-muted text-sm uppercase tracking-widest font-bold">Statement of Financial Position</p>
 </div>
