...
export function LedgerEntryActions({ entryId, status, isLocked }: { entryId: number, status: string, isLocked: boolean }) {
 ...
 className="p-1.5 hover:bg-app-surface-2 rounded text-app-text-muted disabled:opacity-30"
 title="Edit Entry"
 >
 <Edit2 size={14} />
 </button>
 ...
 className="p-1.5 hover:bg-app-surface-2 rounded text-app-text-muted"
 title="View Details"
 >
 <Eye size={14} />
 </button>
