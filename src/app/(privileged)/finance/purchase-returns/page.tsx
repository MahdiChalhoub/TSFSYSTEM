...
export default function PurchaseReturnsPage() {
 ...
 <div className="w-8 h-8 rounded-lg bg-app-surface-2 flex items-center justify-center text-app-text-faint">
 <User size={14} />
 </div>
 <div className="flex flex-col">
 <span className="font-bold text-app-text text-sm">{r.supplier_name || 'Generic Vendor'}</span>
 ...
 render: (r) => <span className="text-xs text-app-text-muted font-medium truncate max-w-[200px] inline-block">{r.reason || 'No reason provided'}</span>
 },
 {
 key: 'status',
 label: 'Workflow',
 ...
 <p className="text-sm font-medium text-app-text-faint mt-2 uppercase tracking-widest">Procurement Reversals & Supplier Credits</p>
 </div>
 ...
 <div>
 <p className="text-[10px] font-black uppercase tracking-widest text-app-text-faint">Total Manifests</p>
 <p className="text-3xl font-black mt-1 tracking-tighter text-app-text">{stats.total}</p>
 <p className="text-[10px] text-app-text-faint font-bold uppercase mt-1">Lifecycle Activity</p>
 </div>
 </CardContent>
 </Card>
 <Card className="rounded-3xl border-0 shadow-sm bg-app-surface overflow-hidden group">
 ...
 <div>
 <p className="text-[10px] font-black uppercase tracking-widest text-app-text-faint">Active Requests</p>
 ...
 <div>
 <p className="text-[10px] font-black uppercase tracking-widest text-app-text-faint">Recovery Value</p>
