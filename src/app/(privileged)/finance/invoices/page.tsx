...
const SUB_TYPE_CONFIG: Record<string, { label: string; color: string; bg: string }> = {
 RETAIL: { label: 'Retail', color: 'text-app-text-muted', bg: 'bg-app-bg border-app-border' },
 ...
 STANDARD: { label: 'Standard', color: 'text-app-text-muted', bg: 'bg-app-bg border-app-border' },
}
...
export default function InvoicesPage() {
 ...
 key: 'type',
 label: 'Type',
 render: (inv) => <span className="text-xs font-medium text-app-text-muted">{TYPE_LABELS[inv.type] || inv.type}</span>
 },
 ]
 ...
 align: 'right',
 sortable: true,
 render: (inv) => <span className="font-semibold text-app-text">{fmt(inv.total_amount)}</span>
 },
 {
 key: 'balance_due',
 label: 'Balance',
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-xs font-bold text-app-text-faint uppercase tracking-wider">Total</p>
 <p className="text-3xl font-bold text-app-text mt-1">{dashboard?.total_invoices || 0}</p>
 </div>
 <div className="w-12 h-12 rounded-2xl bg-stone-200/60 flex items-center justify-center">
 <Receipt size={22} className="text-app-text-muted" />
 </div>
 </div>
 </CardContent>
 </Card>
 ...
 <label className="text-xs font-bold text-app-text-muted uppercase">Type *</label>
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-bold text-app-text-muted uppercase">Sub-Type</label>
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-bold text-app-text-muted uppercase">Contact *</label>
 <input
 type="text"
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-bold text-app-text-muted uppercase">Issue Date *</label>
 <Input name="issue_date" type="date" required className="rounded-xl" defaultValue={new Date().toISOString().split('T')[0]} />
 </div>
 <div className="space-y-1.5">
 <label className="text-xs font-bold text-app-text-muted uppercase">Payment Terms *</label>
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-bold text-app-text-muted uppercase">Display Mode</label>
 ...
 <label className="text-xs font-bold text-app-text-muted uppercase">Notes</label>
 ...
 <Button size="sm" variant="ghost" className="h-7 px-2 text-app-text-faint hover:bg-app-bg"
 ...
 ? "bg-app-surface shadow-sm font-bold text-indigo-600"
 ...
 className="pl-9 h-11 rounded-xl text-sm border-0 bg-app-surface-2 focus-visible:ring-indigo-500/30"
 />
 </div>
 </div>
 }
