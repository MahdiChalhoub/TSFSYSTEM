            ...
            <div className="bg-[#0f172a] border border-white/10 rounded-[2rem] shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                >
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-white italic">Log Fleet <span className="text-app-info">Expense</span></h2>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-5">
                    ...
                    <div className="pt-4 flex gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={saving}
                            className="flex-[2] py-4 bg-app-info text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-blue-500/20 flex items-center justify-center gap-2 hover:from-blue-500 hover:to-blue-400 transition-all disabled:opacity-50"
                        >
