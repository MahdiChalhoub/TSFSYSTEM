...
export default function CreateShippingRatesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('client_portal/shipping-rates/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/client_portal/shipping-rates'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new shipping rates to the system
          </p>
        </div>
      </div>
