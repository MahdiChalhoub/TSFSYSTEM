...
export default function DashboardDetailPage() {
  ...
  async function loadData() {
    try {
      setLoading(true)
      const data = await erpFetch(`client_portal/dashboard/${id}/`)
      setItem(data)
    } catch (error) {
  ...
  async function handleDelete() {
    ...
    try {
      await erpFetch(`client_portal/dashboard/${id}/`, {
        method: 'DELETE'
      })
      router.push('/client_portal/dashboard')
    } catch (error) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button
              variant="outline"
              onClick={() => router.push(`/client_portal/dashboard/${id}/edit`)}
            >
