...
export default function CreateMyTicketsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('client_portal/my-tickets/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/client_portal/my-tickets'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new my tickets to the system
          </p>
        </div>
      </div>
