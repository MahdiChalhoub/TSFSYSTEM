...
export default function CreateAdminOrdersPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('client_portal/admin-orders/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/client_portal/admin-orders'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new admin orders to the system
          </p>
        </div>
      </div>
