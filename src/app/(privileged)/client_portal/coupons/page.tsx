...
type Coupons = Record<string, any>

const ALL_COLUMNS: ColumnDef<Coupons>[] = [
...
export default function CouponsListPage() {
  ...
  const settings = useListViewSettings('client_portal_coupons', {
  ...
  async function loadData() {
    try {
      setLoading(true)
      const data = await erpFetch('client_portal/coupons/')
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<Coupons>
        ...
        headerExtra={
          <Button
            onClick={() => router.push('/client_portal/coupons/new')}
        ...
        actions={{
          onView: (r) => router.push(`/client_portal/coupons/${r.id}`),
          onEdit: (r) => router.push(`/client_portal/coupons/${r.id}/edit`),
        }}
      >
        <TypicalFilter
