...
export default function CreateOrderLinesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('client_portal/order-lines/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/client_portal/order-lines'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new order lines to the system
          </p>
        </div>
      </div>
