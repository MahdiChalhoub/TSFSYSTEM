            ...
            <TreeMasterPage
                ...
                config={{
                    ...
                    columnHeaders: mode === 'gateway' ? [
                        { label: 'Gateway', width: 'auto', sortKey: 'name' },
                        { label: 'Code', width: '90px', hideOnMobile: true, sortKey: 'code' },
                        { label: 'Family', width: '120px', color: 'var(--app-warning)', hideOnMobile: true, sortKey: 'family' },
                        { label: 'Countries', width: '110px', color: 'var(--app-info, #3b82f6)', hideOnMobile: true, sortKey: 'country_count' },
                        { label: 'Fields', width: '70px', color: 'var(--app-accent)', hideOnMobile: true, sortKey: 'field_count' },
                        { label: 'Status', width: '80px', color: 'var(--app-success, #22c55e)', hideOnMobile: true, sortKey: 'is_active' },
                    ] : [
                        { label: 'Country', width: 'auto', sortKey: 'name' },
                        { label: 'ISO', width: '90px', hideOnMobile: true, sortKey: 'iso2' },
                        { label: 'Region', width: '110px', color: 'var(--app-warning)', hideOnMobile: true, sortKey: 'region' },
                        { label: 'Gateways', width: '80px', color: 'var(--app-success, #22c55e)', hideOnMobile: true, sortKey: 'gateway_count' },
                    ],
                    emptyState: {
