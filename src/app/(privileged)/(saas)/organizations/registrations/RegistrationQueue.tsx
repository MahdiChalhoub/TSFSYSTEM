                ...
                <Card key={user.id} className="overflow-hidden border-app-border rounded-[2rem] shadow-sm hover:shadow-md transition-shadow">
                    <CardContent className="p-0">
                        <div className="flex flex-col lg:flex-row">
                            <div className="p-6 lg:w-1/3 bg-app-surface/50 border-r border-app-border">
                            ...
                            <div className="flex-1 p-6 flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <Button
                                        ...
                                        disabled={loadingMap[user.id]}
                                        className="h-12 px-8 rounded-2xl bg-app-bg hover:bg-app-foreground text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-gray-200 transition-all flex items-center gap-2"
                                    >
