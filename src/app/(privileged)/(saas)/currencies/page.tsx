...
export default function CurrenciesPage() {
 ...
 return (
 <div className="app-page p-6 max-w-4xl">
 {/* Header */}
 <div className="flex items-center justify-between mb-8">
 <div className="flex items-center gap-3">
 <div className="p-2.5 bg-gradient-to-br from-amber-500 to-orange-600 rounded-xl text-app-foreground shadow-lg">
 <Coins size={22} />
 </div>
 <div>
 <h1 className="page-header-title tracking-tighter text-app-foreground flex items-center gap-4">
 <div className="w-14 h-14 rounded-[1.5rem] bg-app-warning flex items-center justify-center shadow-lg shadow-amber-200">
 <Coins size={28} className="text-app-foreground" />
 </div>
 Currency <span className="text-app-warning">Management</span>
 </h1>
 <p className="text-sm font-medium text-app-muted-foreground mt-2 uppercase tracking-widest">Exchange Rates</p>
 <p className="text-sm text-app-muted-foreground">Manage available currencies across the platform</p>
 </div>
 </div>
 <button
 onClick={() => { resetForm(); setShowForm(true) }}
 className="flex items-center gap-2 bg-app-background text-app-foreground px-4 py-2.5 rounded-lg text-sm font-semibold hover:bg-app-surface-2 transition-colors shadow-sm"
 >
 <Plus size={16} />
 Add Currency
 </button>
 ...
 disabled={isPending}
 className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-app-foreground bg-app-background rounded-lg hover:bg-app-surface-2 transition-colors disabled:opacity-50"
 >
 ...
 <tr key={c.id} className="hover:bg-app-background transition-colors">
