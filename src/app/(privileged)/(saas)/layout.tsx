...
export default async function SaasLayout({
    ...
    if (!user || !user.is_superuser) {
        ...
        // Redirect to SaaS login page (NOT /admin/ which is Django's admin panel)
        redirect('/saas/login?error=unauthorized_saas_access');
    }

    return (
        <div className="bg-app-surface-2/50 min-h-full">
