    ...
    return (
        <div className="flex items-center justify-center min-h-[80vh] p-8">
            <div className="max-w-lg w-full text-center">
                ...
                {/* Subtitle / Path */}
                <div className="mt-3 inline-block px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl">
                ...
                {/* Message */}
                <div className="mt-6 p-5 rounded-2xl bg-gray-50 border border-gray-100 text-left space-y-3 max-w-sm mx-auto">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-start gap-2.5">
                            ...
                            <p className="text-sm text-gray-500">A mistyped URL or broken link</p>
                        </div>
                        <div className="flex items-start gap-2.5">
                            <div className="w-1.5 h-1.5 rounded-full bg-rose-400 mt-1.5 shrink-0" />
                            <p className="text-sm text-gray-500">A page that was moved or removed</p>
                        </div>
                        <div className="flex items-start gap-2.5">
                            <div className="w-1.5 h-1.5 rounded-full bg-rose-400 mt-1.5 shrink-0" />
                            <p className="text-sm text-gray-500">A feature not available for your account</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl
                            bg-white text-gray-600 text-sm font-bold
