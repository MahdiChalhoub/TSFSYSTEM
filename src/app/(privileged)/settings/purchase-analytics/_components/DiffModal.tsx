...
/**
 * Diff Modal — Unsaved Changes Viewer
 * ======================================
 */
...
export function DiffModal({ entries, onClose }: {
  entries: DiffEntry[]
  onClose: () => void
}) {
  return (
          ...
          {entries.length === 0 ? (
            ...
            <div key={i} className="rounded-lg border border-app-border/40 bg-app-background/50 p-2.5">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="rounded-md bg-app-primary/5 border border-app-success/10 px-2 py-1">
