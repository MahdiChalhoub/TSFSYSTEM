    ...
    return (
        <main className="space-y-[var(--layout-section-spacing)] animate-in fade-in duration-500 pb-20">
            <div className="layout-container-padding max-w-[1200px] mx-auto space-y-[var(--layout-section-spacing)]">
                <Link href="/settings" className="inline-flex items-center gap-2 text-sm font-bold text-app-muted-foreground hover:text-app-foreground transition-colors min-h-[44px] md:min-h-[auto]">
                    ← Back to Settings
                </Link>
