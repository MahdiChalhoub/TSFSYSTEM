                ...
                <div className="bg-app-surface rounded-[2rem] border border-app-border shadow-sm p-4 h-full flex flex-col">
                    ...
                    <div className="relative mb-4 px-2">
                        ...
                        <Input
                            ...
                            className="pl-9 h-10 rounded-xl bg-app-surface border-none text-xs font-medium"
                            value={searchQuery}
                                ...
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        selectedRole?.id === role.id
                                            ? "bg-app-bg text-white shadow-lg shadow-gray-200"
                                            : "hover:bg-app-surface text-app-muted-foreground"
                                    )}
                                >
                                    <div className="flex items-center gap-3">
                                        <div className={cn(
                                            "w-8 h-8 rounded-lg flex items-center justify-center",
                                            selectedRole?.id === role.id ? "bg-app-surface/20" : "bg-app-surface-2"
                                        )}>
                                            <Shield size={16} className={selectedRole?.id === role.id ? "text-white" : "text-app-muted-foreground"} />
                                        </div>
                                        <div>
                                            <p className="text-sm font-black tracking-tight">{role.name}</p>
                                            <p className={cn(
                                                "text-[10px] font-bold uppercase",
                                                selectedRole?.id === role.id ? "text-app-faint" : "text-app-muted-foreground"
                                            )}>
                    ...
                    <div className="space-y-6 pt-4">
                        ...
                        <div className="flex gap-3 pt-2">
                            ...
                            <Button
                                ...
                                className="flex-1 h-14 rounded-2xl bg-app-bg text-white text-[10px] font-black uppercase tracking-widest"
                            >
