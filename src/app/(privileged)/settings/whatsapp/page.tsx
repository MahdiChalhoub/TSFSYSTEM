...
export default function WhatsappSettingsPage() {
 ...
 <div>
 <h2 className="text-sm font-black text-app-text-muted uppercase tracking-widest">Master Control</h2>
 <p className="text-xs text-app-text-faint mt-1 font-medium">
 ...
 <label className="text-xs font-bold text-app-text-faint uppercase tracking-widest">Select Provider</label>
 ...
 : "border-app-border bg-app-surface hover:border-emerald-200 text-app-text-muted"
 )}
 >
 <Settings size={24} className={config.provider === prov ? "text-emerald-500" : "text-app-text-faint"} />
 ...
 <h2 className="text-sm font-black text-app-text-muted uppercase tracking-widest">
 ...
 <label className="text-xs font-bold text-app-text-faint uppercase tracking-widest flex items-center gap-2">
 ...
 className="w-full bg-app-bg border-app-border text-sm font-bold rounded-xl h-11 px-4 focus:ring-emerald-500"
 ...
 required={config.is_active}
 />
 <p className="text-xs text-app-text-faint">Include 'whatsapp:' prefix if required by Twilio</p>
 </div>
 </>
 )}
