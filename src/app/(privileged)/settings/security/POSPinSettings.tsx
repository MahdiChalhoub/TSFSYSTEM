    ...
    return (
        <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-lg font-black text-gray-900 uppercase tracking-tighter">POS Access PINs</h2>
                    <p className="text-xs text-gray-400 font-medium tracking-tight">Manage your Point of Sale login and authorization PINs</p>
                </div>
            </div>
                ...
                <div className="flex items-center gap-2">
                    <div className="relative flex-1">
                        <input
                            ...
                            maxLength={6}
                            className="w-full px-4 py-2.5 bg-white border border-indigo-200 rounded-xl text-sm font-mono font-bold text-gray-900 outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400 tracking-[0.3em] text-center transition-all"
                        />
                        <button onClick={() => setShowPos(v => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-300 hover:text-gray-500 transition-colors">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="relative flex-1">
                            <input
                                ...
                                maxLength={6}
                                className="w-full px-4 py-2.5 bg-white border border-rose-200 rounded-xl text-sm font-mono font-bold text-gray-900 outline-none focus:ring-2 focus:ring-rose-300 focus:border-rose-400 tracking-[0.3em] text-center transition-all"
                            />
                            <button onClick={() => setShowOverride(v => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-300 hover:text-gray-500 transition-colors">
