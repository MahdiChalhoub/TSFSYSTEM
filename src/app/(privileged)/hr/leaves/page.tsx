...
export default async function LeavesPage() {
 ...
 <p className="text-sm font-medium text-app-text-faint mt-2 uppercase tracking-widest">Absence Governance & Approval Workflow</p>
 </div>
 {/* Approval Pulse */}
 ...
 <div>
 <p className="text-[10px] font-black text-app-text-faint uppercase tracking-widest mt-1 leading-none mb-1">Pending Auth</p>
