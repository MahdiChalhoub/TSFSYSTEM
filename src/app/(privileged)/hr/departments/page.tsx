...
export default async function DepartmentsPage() {
 ...
 <div className="w-12 h-12 rounded-[20px] bg-gradient-to-br from-violet-600 to-indigo-700 flex items-center justify-center text-app-text shadow-2xl">
 <Building2 size={24} />
 </div>
 <span className="text-[10px] font-black text-app-text-faint uppercase tracking-[0.4em]">Organization</span>
 </div>
 <h1 className="text-6xl lg:text-7xl font-black text-app-text tracking-tighter">
 Depart<span className="text-violet-600">ments</span>
 </h1>
 <p className="text-app-text-muted font-medium max-w-xl text-lg leading-relaxed">
 ...
 <div className="text-5xl font-black text-app-text tracking-tighter mb-1">{departments.length}</div>
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest">Total</div>
 </div>
 <div className="text-center px-8 border-r border-app-border">
 <div className="text-5xl font-black text-violet-600 tracking-tighter mb-1">{active}</div>
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest">Active</div>
 </div>
 <div className="text-center px-8">
 <div className="text-5xl font-black text-emerald-600 tracking-tighter mb-1">{roots}</div>
 <div className="text-[10px] font-black text-app-text-faint uppercase tracking-widest">Root Depts</div>
 </div>
 </div>
 </div>
