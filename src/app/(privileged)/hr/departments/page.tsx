...
export default async function DepartmentsPage() {
 ...
 <div className="w-12 h-12 rounded-[20px] bg-gradient-to-br from-violet-600 to-indigo-700 flex items-center justify-center text-app-foreground shadow-2xl">
 <Building2 size={24} />
 </div>
 ...
 Depart<span className="text-app-primary">ments</span>
 </h1>
 ...
 <div className="text-center px-8 border-r border-app-border">
 <div className="text-5xl font-black text-app-primary tracking-tighter mb-1">{active}</div>
 <div className="text-[10px] font-black text-app-muted-foreground uppercase tracking-widest">Active</div>
 </div>
 <div className="text-center px-8">
 <div className="text-5xl font-black text-app-primary tracking-tighter mb-1">{roots}</div>
