...
export default function PrivilegedError({
    ...
    useEffect(() => {
        reportError(error, 'error-boundary', { scope: 'privileged' })
    }, [error])
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-app-background p-8 text-center">
            <div className="w-16 h-16 rounded-3xl bg-app-error-bg flex items-center justify-center text-app-error mb-6 shadow-lg shadow-red-200">
                <AlertCircle size={32} />
            </div>
            ...
            <div className="mt-8 bg-app-surface border border-app-border p-4 rounded-2xl max-w-md w-full text-left">
                ...
                <p className="text-xs font-mono text-app-muted-foreground break-all bg-app-background p-3 rounded-lg border border-app-border">
            ...
            <div className="mt-10 flex gap-4">
                <Button
                    onClick={() => reset()}
                    className="bg-app-primary hover:bg-app-primary text-app-foreground px-8 py-6 rounded-2xl font-black shadow-lg shadow-emerald-200 transition-all flex gap-3"
                >
                    <RotateCcw size={18} />
                    Try Again
                </Button>
                <Button
                    ...
                    className="border-app-border bg-app-surface hover:bg-app-background text-app-muted-foreground px-8 py-6 rounded-2xl font-black transition-all"
                >
                    Go to Dashboard
                </Button>
            </div>
