...
export default function CreateAdminPriceRequestsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('supplier_portal/admin-price-requests/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/supplier_portal/admin-price-requests'), 500)
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen layout-container-padding bg-app-bg">
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          <h1>
            Create Admin Price Requests
          </h1>
          <p className="text-app-muted-foreground mt-1">
            Add a new admin price requests to the system
          </p>
        </div>
      </div>
