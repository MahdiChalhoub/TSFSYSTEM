...
export default function CreateProformaLinesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('supplier_portal/proforma-lines/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/supplier_portal/proforma-lines'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new proforma lines to the system
          </p>
        </div>
      </div>
