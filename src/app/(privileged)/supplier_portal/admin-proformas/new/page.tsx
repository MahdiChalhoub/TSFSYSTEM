...
export default function CreateAdminProformasPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('supplier_portal/admin-proformas/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/supplier_portal/admin-proformas'), 500)
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen layout-container-padding bg-app-bg">
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          <h1>
            Create Admin Proformas
          </h1>
          <p className="text-app-muted-foreground mt-1">
            Add a new admin proformas to the system
          </p>
        </div>
      </div>
