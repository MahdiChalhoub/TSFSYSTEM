...
export default function CreateMyPriceRequestsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('supplier_portal/my-price-requests/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/supplier_portal/my-price-requests'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          <h1 className="text-3xl md:text-4xl font-black theme-text">
            Create My Price Requests
          </h1>
          <p className="theme-text-muted mt-1">
            Add a new my price requests to the system
          </p>
        </div>
      </div>
