...
export default function CreateCountingLinesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('inventory/counting-lines/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/inventory/counting-lines'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new counting lines to the system
          </p>
        </div>
      </div>
