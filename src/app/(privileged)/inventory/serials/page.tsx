...
export default function SerialsPage() {
 ...
 <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-app-text-faint mb-4">
 <Link href="/" className="hover:text-app-text transition-colors flex items-center gap-1">
 <Home size={10} /> HOME
 </Link>
 <ChevronRight size={10} />
 <Link href="/inventory" className="hover:text-app-text transition-colors">
 INVENTORY
 </Link>
 <ChevronRight size={10} />
 <span className="text-app-text">SERIAL TRACKING</span>
 </div>
 ...
 <p className="text-sm text-app-text-faint font-medium tracking-tight mt-1">
