...
export default function SerialsPage() {
 return (
 <div className="app-page flex flex-col min-h-screen bg-[#fafafa] bg-app-background">
 {/* Header Section */}
 ...
 <div className="w-14 h-14 bg-app-surface text-app-foreground rounded-2xl flex items-center justify-center shadow-2xl shadow-app-border/20">
 <Barcode size={28} />
 </div>
 <div>
