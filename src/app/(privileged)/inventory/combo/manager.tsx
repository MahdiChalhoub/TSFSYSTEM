...
export default function ComboManager({
 ...
 : 'border-app-border hover:border-purple-300 hover:bg-app-background'
 }`}
 >
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 bg-purple-600 text-app-foreground text-sm font-medium rounded-lg hover:bg-purple-700 transition-colors"
 >
 <Plus size={14} />
 Add Component
 </button>
 ...
 <div
 key={c.id}
 className="flex items-center gap-4 p-3 bg-app-background rounded-xl hover:bg-app-surface-2 transition-colors"
 >
 ...
 <span className={`font-bold ${selectedCombo.selling_price_ttc < totalComponentValue ? 'text-app-primary' : 'text-orange-600'}`}>
 {fmt(selectedCombo.selling_price_ttc)}
 </span>
 {selectedCombo.selling_price_ttc < totalComponentValue && (
 <span className="text-xs text-app-primary ml-1">
 ...
 {/* Add Component Modal */}
 {showAddModal && (
 <div className="fixed inset-0 bg-app-background/50 z-50 flex items-center justify-center p-4">
