...
export default function CreateStockMovesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('inventory/stock-moves/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/inventory/stock-moves'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="theme-text-muted mt-1">
            Add a new stock moves to the system
          </p>
        </div>
      </div>
