        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div className="flex gap-4">
                    <button className="px-8 py-4 bg-app-surface border border-app-border rounded-[28px] font-black uppercase text-[10px] tracking-widest text-app-muted-foreground hover:text-indigo-600 hover:border-indigo-100 transition-all shadow-xl shadow-gray-200/50">
                        Export Master Sheet
                    </button>
