...
export default function LowStockPage() {
 ...
 <CardContent className="py-4 text-center">
 <DollarSign size={24} className="mx-auto mb-2 text-app-primary" />
 <p className="text-xl font-bold text-app-primary">{fmt(stats.total_restock_value)}</p>
 <p className="text-xs text-app-primary uppercase font-medium">Restock Cost</p>
 </CardContent>
 </Card>
 </div>
 ...
 <CardContent className="app-page p-0">
 {products.length === 0 ? (
 <div className="text-center py-16 text-app-muted-foreground">
 <Package size={48} className="mx-auto mb-3 opacity-30" />
 <p className="text-lg font-medium text-app-primary">All stocked up!</p>
 ...
 return (
 <TableRow key={p.product_id} className="hover:bg-app-surface-2/50">
 <TableCell>
 ...
 <div
 className={`h-full rounded-full ${p.severity === 'OUT' ? 'bg-app-error' : p.severity === 'CRITICAL' ? 'bg-orange-500' : 'bg-app-warning'}`}
 ...
 <TableCell className="text-right font-bold text-app-primary">{fmt(p.restock_value)}</TableCell>
 </TableRow>
 )
 })}
 </TableBody>
