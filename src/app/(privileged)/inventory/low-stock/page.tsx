...
export default function LowStockPage() {
 ...
 <p className="text-sm text-app-text-muted mt-2">Products at or below minimum stock levels</p>
 </header>
 ...
 <TrendingDown size={24} className="mx-auto mb-2 text-app-text-faint" />
 <p className="text-3xl font-bold">{stats.total_alerts}</p>
 <p className="text-xs text-app-text-muted uppercase font-medium">Total Alerts</p>
 </CardContent>
 </Card>
 <Card
 ...
 <Package size={18} className="text-app-text-faint" />
 Product Details
 </CardTitle>
 ...
 <TableCell className="font-mono text-xs text-app-text-muted">{p.barcode || '—'}</TableCell>
 ...
 <TableCell className="text-right text-app-text-muted">{p.min_stock_level}</TableCell>
