...
type Products = Record<string, any>

const ALL_COLUMNS: ColumnDef<Products>[] = [
  ...
  return (
    <div className="space-y-4">
      <TypicalListView<Products>
        ...
        actions={{
          onView: (r) => router.push(`/inventory/products/${r.id}`),
          onEdit: (r) => router.push(`/inventory/products/${r.id}/edit`),
        }}
      >
        <TypicalFilter
