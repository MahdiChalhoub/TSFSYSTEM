            ...
            <header className="flex items-center gap-4 fade-in-up">
                ...
                <div>
                    <h1
                        ...
                        style={{ color: 'var(--app-foreground)' }}
                    >
                        {t('inventory.title')} <span style={{ color: 'var(--app-primary)' }}>{t('inventory.movements')}</span>
                    </h1>
                    <p className="text-sm mt-0.5 uppercase tracking-widest text-app-muted-foreground">
                        {t('inventory.udle_active')}
                    </p>
                </div>
            </header>
