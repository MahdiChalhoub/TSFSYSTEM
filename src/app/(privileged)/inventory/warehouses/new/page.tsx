...
export default function CreateWarehousesPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('inventory/warehouses/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/inventory/warehouses'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new warehouses to the system
          </p>
        </div>
      </div>
