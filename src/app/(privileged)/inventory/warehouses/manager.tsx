    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h1 className="text-4xl font-bold text-app-foreground tracking-tight mb-2">Warehouses</h1>
                    <p className="text-app-muted-foreground">Manage storage locations, multi-site logistics, and retail points.</p>
                </div>
                <button
                    onClick={() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="relative">
                    ...
                    <input
                        className="w-full h-full min-h-[76px] pl-12 pr-6 rounded-3xl border border-app-border shadow-sm focus:ring-2 focus:ring-emerald-500 outline-none transition-all placeholder:font-bold"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filtered.length === 0 ? (
                    <div className="col-span-full py-20 text-center">
                        <div className="w-20 h-20 bg-app-surface rounded-full flex items-center justify-center mx-auto mb-4 text-app-faint">
                            <Warehouse size={40} />
                        </div>
                        <p className="text-app-muted-foreground font-bold">No sites matching your search.</p>
                    </div>
                ) : (
                    filtered.map((wh) => (
