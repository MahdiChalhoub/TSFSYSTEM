...
export default function CreateStockAlertsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('inventory/stock-alerts/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/inventory/stock-alerts'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new stock alerts to the system
          </p>
        </div>
      </div>
