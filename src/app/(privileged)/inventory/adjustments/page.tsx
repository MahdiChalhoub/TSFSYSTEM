...
export default async function AdjustmentPage() {
 ...
 <div className="w-14 h-14 rounded-[1.5rem] bg-app-primary flex items-center justify-center shadow-lg shadow-emerald-200 text-app-foreground">
 <Sliders size={28} />
 </div>
 Stock <span className="text-app-primary">Adjustments</span>
 </h1>
 <p className="text-sm font-medium text-app-muted-foreground mt-2 uppercase tracking-widest">Operational Inventory Correction & Audit</p>
 </div>
 </header>
