                                ...
                                <div className="bg-gray-50/80 px-4 py-3 border-b border-gray-100 flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 mt-1">{group.products.length} Variants ΓÇó Total Stock: {totalGroupStock}</p>
                                        </div>
                                    </div>
                                    <Link href={`/products/groups/${group.id}/edit`} className="p-2 text-gray-400 hover:text-emerald-600 hover:bg-white rounded-lg transition-all">
                                        <Edit2 size={16} />
                                    </Link>
                                </div>
