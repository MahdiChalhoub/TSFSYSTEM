...
export default function CreateInventoryMovementsPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await erpFetch('inventory/inventory-movements/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => router.push('/inventory/inventory-movements'), 500)
    } catch (err: any) {
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-app-muted-foreground mt-1">
            Add a new inventory movements to the system
          </p>
        </div>
      </div>
