...
export default function InventoryError({
    ...
    return (
        <div className="flex flex-col items-center justify-center p-8 text-center bg-app-background min-h-[60vh] rounded-2xl border border-app-border/50 shadow-sm relative overflow-hidden">
            {/* Background elements */}
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-red-500/20 via-orange-500/50 to-red-500/20" />

            <div className="w-20 h-20 rounded-3xl bg-orange-500/10 border border-orange-500/20 flex flex-col items-center justify-center text-orange-500 mb-6 shadow-lg shadow-orange-500/10 relative">
                <AlertCircle size={24} className="absolute -top-2 -right-2 text-red-500 bg-app-background rounded-full" />
                <PackageOpen size={36} className="text-orange-400" />
            </div>
            ...
            <p className="text-app-muted-foreground mt-3 font-medium max-w-md mx-auto leading-relaxed">
                An unexpected error occurred while loading this stock view. Your inventory counts and ledgers remain unaffected.
            </p>

            <div className="mt-8 bg-app-surface border border-app-border/60 p-5 rounded-2xl max-w-lg w-full text-left shadow-sm">
                <p className="text-[10px] font-black text-orange-500/70 uppercase tracking-widest mb-2 flex items-center gap-1.5">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
                ...
                <Button
                    variant="outline"
                    onClick={() => window.location.href = '/inventory/stock-ledger'}
