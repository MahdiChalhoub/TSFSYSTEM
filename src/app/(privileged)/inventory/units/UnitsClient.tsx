...
export function UnitsClient({ initialUnits }: { initialUnits: any[] }) {
 ...
 <p className="text-app-text-faint font-medium tracking-tight">Define scaling multipliers and base unit relationships.</p>
 </div>

 <div className="flex items-center gap-4">
 <Link
 href="/inventory/maintenance?tab=unit"
 className="p-3 bg-app-surface border border-app-border rounded-2xl text-app-text-faint hover:text-emerald-600 hover:border-emerald-200 transition-all shadow-sm flex items-center gap-2"
