...
export default function BarcodeSettingsPage() {
 ...
 if (loading) return <div className="app-page p-8 text-center text-app-muted-foreground">Loading settings...</div>;
 ...
 <Barcode size={28} className="text-app-foreground" />
 </div>
 <div>
 <h1 className="page-header-title tracking-tighter">Barcode <span className="text-app-primary">Configuration</span></h1>
 ...
 {/* Preview Box */}
 <div className="bg-app-surface text-app-foreground p-6 rounded-2xl flex flex-col items-center justify-center gap-2 shadow-xl">
 ...
 <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-app-primary"></span> Prefix: {prefix}</span>
 ...
 type="checkbox"
 {...register('isEnabled')}
 className="w-5 h-5 rounded text-app-primary focus:ring-app-primary border-app-border"
 />
 <span className="font-medium text-app-muted-foreground">Enable Automatic Generation</span>
 </label>
 </div>

 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div>
 <label className="block text-sm font-medium text-app-muted-foreground mb-2">Barcode Prefix (2-3 chars)</label>
 <input
 type="text"
 {...register('prefix', { required: true, minLength: 2, maxLength: 3 })}
 className="w-full px-4 py-2 border border-app-border rounded-xl focus:ring-2 focus:ring-app-primary outline-none"
 placeholder="200"
 />
 ...
 <div>
 <label className="block text-sm font-medium text-app-muted-foreground mb-2">Next Sequence Number</label>
 <input
 type="number"
 ...
 {message && (
 <div className={`p-4 rounded-xl flex items-center gap-2 ${message.type === 'success' ? 'bg-app-success-bg text-app-success border border-app-success/30' : 'bg-app-error-bg text-app-error border border-app-error/30'}`}>
 {message.text}
 </div>
 )}
 ...
 type="submit"
 disabled={saving}
 className="bg-app-primary text-app-foreground px-8 py-3 rounded-xl font-bold shadow-lg hover:shadow-app-primary/20 hover:-translate-y-0.5 transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
 >
