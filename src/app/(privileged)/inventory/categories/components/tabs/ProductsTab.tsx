                        ...
                        <div className="px-5 py-3.5 flex items-center justify-between"
                            ...
                            <div className="flex items-center gap-2.5">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] text-app-muted-foreground">{selected.size} product{selected.size > 1 ? 's' : ''} from &ldquo;{categoryName}&rdquo;</p>
                                </div>
                            </div>
                                        ...
                                        {filteredTargets.length === 0 ? (
                                            ...
                                            <button key={cat.id} onClick={() => previewMove(cat.id)}
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    {cat.full_path && cat.full_path !== cat.name && <p className="text-[10px] text-app-muted-foreground truncate">{cat.full_path}</p>}
                                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    {!movePreview.has_conflicts && (
                                        <div className="flex items-center gap-2.5 p-3 rounded-xl" style={{ background: 'color-mix(in srgb, var(--app-success) 6%, transparent)', border: '1px solid color-mix(in srgb, var(--app-success) 15%, transparent)' }}>
                                            ...
                                            <div><p className="text-[12px] font-bold" style={{ color: 'var(--app-success)' }}>Ready to move</p><p className="text-[10px] text-app-muted-foreground">All brands and attributes are compatible.</p></div>
                                        </div>
                                    )}
                                    ...
                                    {movePreview.has_conflicts && (
                                        <>
                                            ...
                                            {movePreview.conflict_brands?.length > 0 && (
                                                <div className="rounded-xl overflow-hidden" style={{ border: '1px solid var(--app-border)' }}>
                                                    <div className="px-3 py-2 flex items-center justify-between" style={{ background: 'color-mix(in srgb, var(--app-surface) 80%, transparent)', borderBottom: '1px solid var(--app-border)' }}>
                                                        <div className="flex items-center gap-1.5"><Paintbrush size={11} style={{ color: '#8b5cf6' }} /><span className="text-[10px] font-black uppercase tracking-widest" style={{ color: '#8b5cf6' }}>Brand Conflicts</span></div>
                                                        <span className="text-[9px] font-bold text-app-muted-foreground">{movePreview.conflict_brands.length} to resolve</span>
                                                    </div>
                                                    <div className="divide-y divide-app-border/30">
                                                                ...
                                                                <div key={b.id} className="px-3 py-2.5">
                                                                    <div className="flex items-center justify-between mb-2">
                                                                        <div className="flex items-center gap-2">
                                                                            ...
                                                                            <span className="text-[9px] font-bold px-1.5 py-0.5 rounded" style={{ background: 'color-mix(in srgb, var(--app-muted-foreground) 8%, transparent)', color: 'var(--app-muted-foreground)' }}>{b.affected_count} product{b.affected_count > 1 ? 's' : ''}</span>
                                                                        </div>
                                                                        <span className="text-[9px] font-black px-1.5 py-0.5 rounded" style={{ background: resolved ? 'color-mix(in srgb, var(--app-success) 10%, transparent)' : 'color-mix(in srgb, var(--app-error) 10%, transparent)', color: resolved ? 'var(--app-success)' : 'var(--app-error)' }}>
                                                                    ...
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        ) : (<span className="text-[9px] font-bold px-2 py-1 rounded-lg" style={{ background: 'color-mix(in srgb, var(--app-error) 8%, transparent)', color: 'var(--app-error)' }}>No brands available — must link</span>))}
                                                                    </div>
                                                                </div>
                                                            )
                                                        })}
                                            ...
                                            {movePreview.conflict_attributes?.length > 0 && (
                                                <div className="rounded-xl overflow-hidden" style={{ border: '1px solid var(--app-border)' }}>
                                                    <div className="px-3 py-2 flex items-center justify-between" style={{ background: 'color-mix(in srgb, var(--app-surface) 80%, transparent)', borderBottom: '1px solid var(--app-border)' }}>
                                                        <div className="flex items-center gap-1.5"><Tag size={11} style={{ color: 'var(--app-warning)' }} /><span className="text-[10px] font-black uppercase tracking-widest" style={{ color: 'var(--app-warning)' }}>Attribute Conflicts</span></div>
                                                        <span className="text-[9px] font-bold text-app-muted-foreground">{movePreview.conflict_attributes.length} to resolve</span>
                                                    </div>
                                                    <div className="divide-y divide-app-border/30">
                                                            ...
                                                            return (
                                                                <div key={a.id} className="px-3 py-2.5">
                                                                    ...
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        ) : (<span className="text-[9px] font-bold px-2 py-1 rounded-lg" style={{ background: 'color-mix(in srgb, var(--app-error) 8%, transparent)', color: 'var(--app-error)' }}>No attributes available — must link</span>))}
                                                                    </div>
                                                                </div>
                                                            )
                                                        })}
