...
export function TransfersClient() {
 ...
 label: 'Reference',
 alwaysVisible: true,
 render: (row: any) => <span className="font-mono text-app-text-muted">{row.reference || `TRF-${row.id}`}</span>
 },
 {
 ...
 label: 'From Location',
 render: (row: any) => <span className="text-app-text-muted">{row.from_warehouse_name || '-'}</span>
 },
 {
 key: 'to_warehouse_name',
 label: 'To Location',
 render: (row: any) => <span className="text-app-text-muted">{row.to_warehouse_name || '-'}</span>
 },
 {
 key: 'reason',
 label: 'Reason',
 ...
 key: 'driver',
 label: 'Driver',
 render: (row: any) => <span className="text-app-text-muted">{row.driver || 'Unassigned'}</span>
 }
 ]
