...
function LoginContent() {
 ...
 <div className="space-y-2">
 <Label className="text-xs uppercase font-bold text-app-text-muted">Verification Code</Label>
 <Input
 name="otp_token"
 placeholder="000 000"
 required
 ...
 {isRoot && (
 <div className="space-y-2">
 <Label className="text-xs uppercase font-bold text-app-text-muted">Workspace</Label>
 ...
 <p className="text-[10px] text-app-text-muted font-bold uppercase tracking-tighter">
 ...
 <div className="space-y-2">
 <Label className="text-xs uppercase font-bold text-app-text-muted">Username</Label>
 <Input
 name="username"
 required
 ...
 <Label className="text-xs uppercase font-bold text-app-text-muted">Password</Label>
