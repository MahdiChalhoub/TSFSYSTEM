...
export default function LandingPage() {
 ...
 <Label className="text-[10px] uppercase tracking-[0.2em] font-black text-app-text-muted flex items-center gap-2">
 Workspace ID
 </Label>
 <Input
 ...
 />
 <p className="text-[10px] text-app-text-muted uppercase font-bold tracking-widest">Connect to your organization's secure instance.</p>
 </div>
 )}
 ...
 <div className="space-y-2">
 <p className="text-[10px] text-app-text-muted uppercase tracking-widest font-black">Suggested Available IDs:</p>
 ...
 className={`py-8 flex flex-col items-center gap-3 transition-all relative ${mode === 'signup' ? 'text-cyan-400' : 'text-app-text-muted hover:text-slate-300'}`}
 >
 <UserPlus size={24} />
