...
export default function DriverDeliveryPage() {
 ...
 <div className="flex flex-col items-center gap-3 text-app-foreground">
 ...
 return (
 <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-950 text-app-foreground bg-app-bg">
 {/* Header */}
 <div className="bg-app-foreground/5 border-b border-app-foreground/10 px-5 py-4 flex items-center gap-3">
 ...
 {/* Recipient */}
 <div className="bg-app-foreground/8 rounded-2xl p-4 border border-app-foreground/10">
 <p className="text-[10px] font-black text-app-foreground/40 uppercase tracking-widest mb-3">Recipient</p>
 ...
 {delivery.city && <p className="text-xs text-app-foreground/60">{delivery.city}</p>}
 {delivery.zone_name && <p className="text-xs text-app-foreground/40">Zone: {delivery.zone_name}</p>}
 </div>
 </div>
 )}
 </div>
 ...
 <div className="bg-app-foreground/8 rounded-2xl p-4 border border-app-foreground/10">
 <p className="text-[10px] font-black text-app-foreground/40 uppercase tracking-widest mb-3">Payment</p>
 <div className="flex items-center justify-between mb-3">
 <div>
 <p className="text-2xl font-black">{amountDue.toFixed(2)}</p>
 <p className="text-xs text-app-foreground/40">
 ...
 <Package size={30} className="text-app-foreground/20" />
 </div>
 ...
 <p className="text-3xl font-black text-app-foreground tracking-[0.35em] text-center py-1">
 ...
 {gpsStatus === 'idle' && !gpsUpdating && <ArrowRight size={16} className="text-app-foreground/30" />}
 </button>
 ...
 <>
 <p className="text-xs text-app-foreground/50 mb-4">
 ...
 placeholder="000000"
 className="flex-1 bg-app-foreground/10 border border-app-foreground/15 rounded-xl px-4 py-3.5 text-2xl font-black text-center tracking-[0.3em] placeholder:text-app-foreground/20 focus:outline-none focus:ring-2 focus:ring-amber-400/60"
 />
 <button
 onClick={handleConfirmDelivery}
 disabled={submitting || clientCode.length < 4}
 className="px-5 rounded-xl bg-app-warning text-app-foreground font-black text-sm hover:bg-amber-400 active:scale-95 transition-all disabled:opacity-50 shadow-lg shadow-amber-500/20"
 >
 ...
 <>
 <p className="text-xs text-app-foreground/50 mb-4">No client code required. Tap to confirm delivery.</p>
 <button
 onClick={handleConfirmDelivery}
 disabled={submitting}
