...
export default function DriverDeliveryPage() {
 ...
 <h1 className="text-app-text text-3xl font-black mb-2">Delivered! 🎉</h1>
 ...
 <Truck size={20} className="text-app-text" />
 </div>
 <div>
 ...
 {/* Recipient */}
 <div className="bg-app-text/8 rounded-2xl p-4 border border-app-text/10">
 <p className="text-[10px] font-black text-app-text/40 uppercase tracking-widest mb-3">Recipient</p>
 ...
 {delivery.city && <p className="text-xs text-app-text/60">{delivery.city}</p>}
 {delivery.zone_name && <p className="text-xs text-app-text/40">Zone: {delivery.zone_name}</p>}
 </div>
 </div>
 )}
 </div>
 ...
 <div className="bg-app-text/8 rounded-2xl p-4 border border-app-text/10">
 <p className="text-[10px] font-black text-app-text/40 uppercase tracking-widest mb-3">Payment</p>
 ...
 <Package size={30} className="text-app-text/20" />
 </div>
 ...
 <p className="text-3xl font-black text-app-text tracking-[0.35em] text-center py-1">
 ...
 <>
 <p className="text-xs text-app-text/50 mb-4">
 ...
 placeholder="000000"
 className="flex-1 bg-app-text/10 border border-app-text/15 rounded-xl px-4 py-3.5 text-2xl font-black text-center tracking-[0.3em] placeholder:text-app-text/20 focus:outline-none focus:ring-2 focus:ring-amber-400/60"
 />
 <button
 ...
 <>
 <p className="text-xs text-app-text/50 mb-4">No client code required. Tap to confirm delivery.</p>
 <button
 onClick={handleConfirmDelivery}
 disabled={submitting}
 className="w-full py-4 rounded-xl bg-emerald-500 text-app-text font-black text-base hover:bg-emerald-400 active:scale-95 transition-all disabled:opacity-50 shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2"
 >
