        ...
        <div className="space-y-10 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div className="flex gap-4">
                    ...
                    <Link
                        href="/admin/products/create-group"
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
                <div className="flex p-1 bg-gray-100 rounded-xl">
                    ...
                    <Link
                        href="/admin/products?view=grouped"
                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${isGrouped ? 'bg-white shadow text-gray-900' : 'text-gray-500 hover:text-gray-700'}`}
                    >
                        Grouped (Master)
                    </Link>
                ...
                <div className="bg-white border-t border-gray-100 px-8 py-6 flex items-center justify-between text-sm text-gray-600">
                    ...
                    {totalPages > 1 && (
                        <div className="flex items-center gap-3">
                            <Link
                                href={`/admin/products?view=${isGrouped ? 'grouped' : 'flat'}&page=${page > 1 ? page - 1 : 1}`}
                            ...
                            <Link
                                href={`/admin/products?view=${isGrouped ? 'grouped' : 'flat'}&page=${page < totalPages ? page + 1 : totalPages}`}
        ...
        <tr className="hover:bg-gray-50/60 transition-colors">
            <td className="py-6 px-8">
                <div className="flex flex-col gap-1">
                    ...
                    <span className="text-xs text-gray-500">{product.brand?.name} • {product.category?.name}</span>
        ...
        <tr className="hover:bg-gray-50/60 transition-colors bg-gray-50/30">
            <td className="py-6 px-8">
                <div className="flex flex-col gap-1">
                    ...
                    <span className="text-xs text-gray-500 pl-6">{group.brand?.name} • {group.category?.name}</span>
                </div>
            </td>
            <td className="py-6 px-8">
                <div className="flex flex-col gap-1">
            ...
            <td className="py-6 px-8 text-right">
                <Link href={`/admin/products/groups/${group.id}/edit`} className="text-sm font-semibold text-emerald-600 hover:text-emerald-700 flex items-center justify-end gap-1">
                    <Edit2 size={16} /> Edit
                </Link>
            </td>
        </tr>
