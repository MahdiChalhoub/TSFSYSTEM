        ...
        return (
            <div className="flex items-center justify-center min-h-[400px]">
                <div className="animate-pulse flex flex-col items-center gap-3">
                    <Package className="w-12 h-12 text-app-muted-foreground" />
                    <span className="text-app-muted-foreground">Checking module status...</span>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh] p-8">
                <div className="max-w-md text-center space-y-6">
                    <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-app-warning-soft border-2 border-app-warning">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 border border-app-border">
                        <div className="flex items-center gap-3 text-sm text-app-muted-foreground">
                            <ArrowUpCircle className="w-5 h-5 text-app-success shrink-0" />
                            <span>
                                Contact your administrator or go to
                                <a href="/saas/modules" className="text-app-success font-medium hover:underline ml-1">
                                    Module Management
