...
export const InventoryStatsWidget = ({ data }: { data: Record<string, any> }) => {
 ...
 return (
 <div className="card-premium p-6 flex flex-col justify-between group cursor-default min-h-[160px] relative overflow-hidden bg-app-surface rounded-2xl border border-app-border shadow-sm">
 <div className="flex justify-between items-start z-10">
 <div>
 <p className="text-sm font-medium text-app-text-muted mb-2">Total Products</p>
 <h3 className="text-3xl font-bold text-app-text tracking-tight">{value.toLocaleString()}</h3>
 </div>
