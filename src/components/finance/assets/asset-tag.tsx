...
export function AssetTag({ asset, size = 'md' }: AssetTagProps) {
 ...
 return (
 <Card className={`${dimensions[size]} bg-app-surface border-2 border-app-border rounded-xl flex shadow-sm animate-in zoom-in-95 duration-300 overflow-hidden`}>
 {/* Left: Metadata */}
 ...
 <h4 className="font-black text-app-foreground leading-tight uppercase line-clamp-2">
 {asset.name}
 </h4>
 ...
 <div className="p-1 bg-app-surface rounded-lg border border-app-border shadow-inner">
 <QRCodeSVG
 value={scanUrl}
 size={qrSizes[size]}
 level="H"
 ...
 <QrIcon size={8} />
 <span className="font-black uppercase tracking-tighter">Scan to Audit</span>
 </div>
 </div>
 </Card>
 )
