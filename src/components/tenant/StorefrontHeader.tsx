...
export function StorefrontHeader() {
 ...
 <Link href={`/tenant/${slug}`}
 className="text-sm text-app-text-faint hover:text-app-text font-medium transition-colors">
 Products
 </Link>
 ...
 className="text-sm text-app-text-faint hover:text-app-text font-medium transition-colors flex items-center gap-1.5">
 ...
 className="w-10 h-10 flex items-center justify-center text-app-text-faint hover:text-app-text transition-colors">
 <Search size={20} />
 </Link>
 ...
 className="relative w-10 h-10 flex items-center justify-center text-app-text-faint hover:text-rose-400 transition-colors">
 <Heart size={20} />
 {wishlistCount > 0 && (
 <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] bg-rose-500 text-[10px] font-black text-app-text rounded-full flex items-center justify-center px-1">
 {wishlistCount}
 </span>
 )}
 </Link>
 ...
 className="relative w-10 h-10 flex items-center justify-center text-app-text-faint hover:text-cyan-400 transition-colors">
 <Bell size={20} />
 </Link>
 )}
 ...
 className="md:hidden w-10 h-10 flex items-center justify-center text-app-text-faint hover:text-app-text">
