...
export function StorefrontHeader() {
 ...
 <Link href={`/tenant/${slug}`}
 className="text-sm text-app-text-faint hover:text-white font-medium transition-colors">
 Products
 </Link>
 ...
 className="text-sm text-app-text-faint hover:text-white font-medium transition-colors flex items-center gap-1.5">
 ...
 className="w-10 h-10 flex items-center justify-center text-app-text-faint hover:text-white transition-colors">
 <Search size={20} />
 </Link>
 ...
 {cartCount > 0 && (
 <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] bg-emerald-500 text-[10px] font-black text-white rounded-full flex items-center justify-center px-1">
 {cartCount}
 </span>
 )}
 </Link>
