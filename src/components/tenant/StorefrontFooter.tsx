...
export function StorefrontFooter() {
 ...
 {/* Quick Links */}
 <div>
 <h4 className="text-[10px] font-black text-app-text-muted uppercase tracking-widest mb-4">Shop</h4>
 ...
 {/* Account Links */}
 <div>
 <h4 className="text-[10px] font-black text-app-text-muted uppercase tracking-widest mb-4">Account</h4>
 <ul className="space-y-2.5">
 <li>
