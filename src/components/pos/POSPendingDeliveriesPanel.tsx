...
export function POSPendingDeliveriesPanel({ sessionId, onClose, currency = '$' }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center">
            ...
            <div className="relative w-full max-w-lg bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom-4 sm:zoom-in-95 duration-300">
                {/* Header */}
                ...
                <div className="max-h-[70vh] overflow-y-auto divide-y divide-gray-100">
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <p className="text-xs text-gray-400 mt-0.5">No pending deliveries for this session</p>
                        </div>
                    ) : (
                        deliveries.map(d => {
                                            ...
                                            {d.require_client_delivery_code && d.client_delivery_code && (
                                                <div className="mt-2 flex items-center gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-5 h-5 flex items-center justify-center text-gray-400 hover:text-orange-500 transition-all"
                                                        title="Copy"
                                                    >
                                                        <Copy size={10} />
                                                    </button>
