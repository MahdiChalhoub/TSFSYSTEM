...
export function POSLayoutClassic(props: POSLayoutProps) {
 ...
 <div className="p-6 border-b border-app-border bg-gray-50/80 backdrop-blur-md">
 ...
 className="w-full pl-11 pr-10 py-3 bg-app-surface border border-app-border rounded-2xl text-[11px] font-black text-gray-700 outline-none appearance-none cursor-pointer focus:border-emerald-500/50 transition-all uppercase tracking-widest italic"
 >
 {deliveryZones.map(z => (
 ...
 className="w-full pl-4 pr-10 py-3 bg-app-surface border border-app-border rounded-2xl text-[11px] font-black text-gray-700 outline-none appearance-none cursor-pointer focus:border-emerald-500/50 transition-all uppercase tracking-widest italic"
 >
 {paymentMethods
 .filter((m: any) => {
