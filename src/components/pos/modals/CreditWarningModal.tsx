...
export function CreditWarningModal({ isOpen, onClose, onConfirm, amount, currency }: CreditWarningModalProps) {
 ...
 <button
 onClick={onClose}
 className="flex-1 py-3.5 border-2 border-app-border rounded-2xl text-app-foreground font-bold text-sm hover:bg-app-bg transition-all font-inter"
 >
 Cancel
 </button>
 <button
 onClick={onConfirm}
 className="flex-1 py-3.5 bg-app-warning hover:bg-app-warning text-app-foreground rounded-2xl font-black text-sm shadow-lg shadow-amber-200 transition-all font-inter"
 >
 ✓ Confirm Credit Sale
 </button>
 </div>
