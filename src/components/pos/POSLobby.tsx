    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 flex flex-col">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 text-[10px] text-white/40 font-bold uppercase tracking-[0.3em]">
                            <span className={step === 'site' ? 'text-indigo-400' : 'text-white/20'}>Site</span>
                            <ChevronRight size={10} />
                            <span className={step === 'register' ? 'text-indigo-400' : 'text-white/20'}>Register</span>
                            <ChevronRight size={10} />
                            <span className={step === 'user' ? 'text-indigo-400' : 'text-white/20'}>Who's working?</span>
                            <ChevronRight size={10} />
                            <span className={step === 'pin' ? 'text-indigo-400' : 'text-white/20'}>PIN</span>
                            <ChevronRight size={10} />
                            <span className={step === 'opening' ? 'text-emerald-400' : 'text-white/20'}>Open</span>
                        </div>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    {selectedSite && (
                        <div className="text-right mr-2">
                            ...
                            {selectedRegister && (
                                <p className="text-indigo-400 text-xs font-bold">{selectedRegister.name}</p>
                            )}
                        </div>
                    )}
                    ...
                    {step === 'site' && (
                        <>
                            <a
                                ...
                                className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-white/40 hover:text-white text-xs font-bold transition-all border border-white/5 hover:border-white/20"
                            ...
                            <div className="flex items-center justify-center gap-2 mb-6">
                                ...
                                >
                                    ...
                                    <span className={clsx(
                                        ...
                                        siteTab === 'with' ? "bg-white/25" : "bg-white/10"
                                ...
                                >
                                    ...
                                    <span className={clsx(
                                        "w-5 h-5 rounded-full text-[10px] font-black flex items-center justify-center",
                                        siteTab === 'without' ? "bg-white/25" : "bg-white/10"
                ...
                {step === 'register' && selectedSite && (
                    <div className="w-full max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-white/40 text-sm">{selectedSite.name} — Choose your workstation</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="mt-3 flex flex-wrap gap-1">
                                            {reg.allowedAccounts.slice(0, 4).map(acc => (
                                                <span key={acc.id} className="px-1.5 py-0.5 rounded bg-white/5 text-white/30 text-[9px] font-bold">
                                                    {acc.name}
                                                </span>
                                            ))}
                                            {reg.allowedAccounts.length > 4 && (
                                                <span className="px-1.5 py-0.5 rounded bg-white/5 text-white/20 text-[9px]">
                                                    +{reg.allowedAccounts.length - 4}
                                                </span>
                                            )}
                                        </div>
                ...
                {step === 'user' && selectedRegister && (
                    <div className="w-full max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-white/40 text-sm">{selectedRegister.name} — tap your name to continue</p>
                        </div>
                ...
                {step === 'pin' && selectedRegister && selectedCashier && (
                    <div className="w-full max-w-sm animate-in fade-in zoom-in-95 duration-500">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-white/40 text-sm">{selectedRegister.name} — {selectedCashier.name}</p>
                        </div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="relative flex-1">
                                            <input
                                                ...
                                                maxLength={6}
                                                className="w-full px-4 py-2.5 bg-black/30 border border-amber-300/30 rounded-xl text-sm font-mono font-bold text-amber-100 outline-none focus:ring-2 focus:ring-amber-400/40 tracking-[0.3em] text-center"
                                            />
                                        </div>
                                        <button
                                            onClick={async () => {
                                ...
                                <>
                                        ...
                                        <div className="flex items-center justify-center gap-3 mb-5">
                                            ...
                                            {!managerUnlocked && (
                                                <button
                                                    ...
                                                    className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white/5 border border-white/10 hover:border-amber-500/30 hover:bg-amber-500/5 transition-all text-xs font-bold text-white/40 hover:text-amber-400"
                                                >
                                                    <Lock size={12} />
                                                    Show Details
                                                </button>
                                    ...
                                    {openingMode === 'standard' ? (
                                        ...
                                        <div className="bg-white/5 rounded-3xl p-6 border border-white/10 space-y-4">
                                            <div>
                                                <label className="text-[10px] text-white/40 uppercase tracking-widest font-bold block mb-1.5">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white text-xl font-black outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/20 transition-all"
                                                        placeholder="0.00"
                                                    />
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <textarea
                                                    ...
                                                    className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white text-sm outline-none focus:border-emerald-500 resize-none h-16"
                                        ...
                                        <div className="bg-white/5 rounded-3xl p-6 border border-violet-500/20 space-y-4">
                                                    ...
                                                    <div key={entry.account_id} className={clsx("grid gap-2 items-center",
                                                        ...
                                                        {managerUnlocked && (
                                                            <span className={clsx(
                                                                ...
                                                                calibration > 0 ? "text-emerald-400" : calibration < 0 ? "text-rose-400" : "text-white/20"
                                                            )}>
                                                ...
                                                <div className={clsx("grid gap-2 items-center",
                                                    ...
                                                    {managerUnlocked && (
                                                        <input
                                                            ...
                                                            className="w-full px-2 py-1.5 bg-white/5 border border-white/10 rounded-lg text-white text-xs font-bold text-center outline-none focus:border-emerald-500"
                                                        />
                                                    )}
                                                    <input
                                                        type="number"
                                                    ...
                                                    />
                                                    <span className="text-xs font-black text-white/20 text-center">—</span>
                                                </div>
                                            </div>
                                            ...
                                            {managerUnlocked ? (
                                                ...
                                                <div className="bg-slate-800/50 rounded-2xl p-4 border border-white/5 space-y-2">
                                                    ...
                                                    <div className="flex justify-between text-xs">
                                                        <span className="text-white/50">Cash (software)</span>
                                                        <span className="text-white font-bold">{currency}{cashSW.toFixed(0)}</span>
                                                    </div>
                                                    <div className="flex justify-between text-xs">
                                                        <span className="text-white/50">Calibration adjustment</span>
                                                        <span className={clsx("font-bold", totalCalibration > 0 ? "text-rose-400" : totalCalibration < 0 ? "text-emerald-400" : "text-white/30")}>
                                                            {totalCalibration > 0 ? '+' : ''}{(-totalCalibration).toFixed(0)}
                                                        </span>
                                                    </div>
                                                    <div className="flex justify-between text-xs border-t border-white/5 pt-2">
                                                        <span className="text-white/70 font-bold">Cash expected</span>
                                                        <span className="text-white font-black">{currency}{cashExpected.toFixed(0)}</span>
                                                    </div>
                                                    <div className="flex justify-between text-xs">
                                                        <span className="text-white/50">Cash counted (real)</span>
                                                        <span className="text-white font-bold">{currency}{cashRL.toFixed(0)}</span>
                                                    </div>
                                                    <div className="flex justify-between text-xs border-t border-white/5 pt-2">
                                                        <span className="text-white/70 font-bold">Cash gap</span>
                                                        <span className={clsx("font-black", cashGap > 0 ? "text-emerald-400" : cashGap < 0 ? "text-rose-400" : "text-white/30")}>
                                                    ...
                                                    <div className="flex justify-between text-sm border-t border-white/10 pt-2">
                                                        ...
                                                        <span className={clsx(
                                                            "font-black text-lg",
                                                            finalGap > 0 ? "text-emerald-400" : finalGap < 0 ? "text-rose-400" : "text-white/50"
                                                        )}>
                                            ...
                                            <textarea
                                                value={openingNotes}
                                                onChange={(e) => setOpeningNotes(e.target.value)}
                                                className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white text-sm outline-none focus:border-violet-500 resize-none h-14"
            ...
            <footer className="px-8 py-3 border-t border-white/5 bg-black/20 flex items-center justify-between">
                <p className="text-[10px] text-white/15 font-mono">POS Terminal v2.9</p>
                <div className="flex items-center gap-4">
