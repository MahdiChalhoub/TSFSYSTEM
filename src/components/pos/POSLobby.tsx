...
export default function POSLobby({ currency, onEnterPOS }: POSLobbyProps) {
 ...
 <span className={step === 'site' ? 'text-indigo-400' : 'text-app-text/20'}>Site</span>
 <ChevronRight size={10} />
 <span className={step === 'register' ? 'text-indigo-400' : 'text-app-text/20'}>Register</span>
 <ChevronRight size={10} />
 <span className={step === 'user' ? 'text-indigo-400' : 'text-app-text/20'}>Who's working?</span>
 <ChevronRight size={10} />
 ...
 className="flex items-center gap-2 px-3 py-2 rounded-xl bg-app-text/5 hover:bg-app-text/10 text-app-text/40 hover:text-app-text text-xs font-bold transition-all border border-app-text/5 hover:border-app-text/20"
 ...
 siteTab === 'with'
 ? "bg-indigo-500 text-app-text shadow-lg shadow-indigo-500/30"
 ...
 siteTab === 'with' ? "bg-app-text/25" : "bg-app-text/10"
 ...
 <span className={clsx(
 "w-5 h-5 rounded-full text-[10px] font-black flex items-center justify-center",
 siteTab === 'without' ? "bg-app-text/25" : "bg-app-text/10"
 ...
 <p className="text-app-text/30 font-bold">
 {siteTab === 'with' ? 'No sites with registers' : 'All sites have registers'}
 </p>
 <p className="text-app-text/15 text-sm mt-1">
 ...
 <p className="text-app-text/40 text-sm">{selectedSite.name} — Choose your workstation</p>
 </div>
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
 ...
 <span key={acc.id} className="px-1.5 py-0.5 rounded bg-app-text/5 text-app-text/30 text-[9px] font-bold">
 {acc.name}
 </span>
 ))}
 {reg.allowedAccounts.length > 4 && (
 <span className="px-1.5 py-0.5 rounded bg-app-text/5 text-app-text/20 text-[9px]">
 +{reg.allowedAccounts.length - 4}
 </span>
 )}
 </div>
 ...
 <p className="text-app-text/40 text-sm">{selectedRegister.name} — tap your name to continue</p>
 </div>
 ...
 <p className="text-app-text/40 text-sm">{selectedRegister.name} — {selectedCashier.name}</p>
 </div>
 ...
 : "border-app-text/10 bg-app-text/5"
 )}
 >
 {i < pin.length && (
 ...
 <div>
 <label className="text-[10px] text-app-text/40 uppercase tracking-widest font-bold block mb-1.5">
 ...
 <div className="flex justify-between text-xs">
 <span className="text-app-text/50">Cash counted (real)</span>
 ...
 {finalGap !== 0 && (
 <p className="text-xs text-app-text/30 mt-2">
 ...
 value={openingNotes}
 onChange={(e) => setOpeningNotes(e.target.value)}
 className="w-full px-4 py-2 bg-app-text/5 border border-app-text/10 rounded-xl text-app-text text-sm outline-none focus:border-violet-500 resize-none h-14"
 ...
 <p className="text-[10px] text-app-text/15 font-mono">POS Terminal v2.9</p>
 <div className="flex items-center gap-4">
