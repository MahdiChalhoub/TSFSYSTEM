...
export function TenantSwitcher({ organizations, forcedSlug, user }: { organizations: Record<string, any>[], forcedSlug?: string, user?: Record<string, any> }) {
 ...
 : "bg-app-primary/10 border-app-primary/20 hover:bg-app-primary/20 cursor-pointer"
 )}
 >
 <div className="w-7 h-7 rounded-lg bg-app-primary flex items-center justify-center text-app-text shadow-lg shadow-app-primary/20">
 <Building size={14} />
 </div>
 <div className="text-left hidden lg:block">
 <div className="text-[10px] font-black text-app-primary uppercase tracking-widest leading-none mb-0.5">
 ...
 */}
 ...
 <div className="p-4 border-b border-app-border bg-app-surface-2 flex justify-between items-center">
 <h4 className="text-xs font-black text-app-text-muted uppercase tracking-widest text-[10px]">Select Managed Version</h4>
 {showMasterPanel && (
 <span className="px-2 py-0.5 bg-app-primary-light text-app-success text-[8px] font-bold rounded-full uppercase tracking-tighter shadow-sm">Super Admin</span>
 )}
 </div>
 ...
 org.slug === currentSlug ? "bg-app-primary text-app-text shadow-lg shadow-app-primary/20" : "hover:bg-app-bg text-app-text-muted hover:text-app-text"
 )}
 >
 ...
 {showMasterPanel && (
 <div className="p-3 bg-app-surface-2 border-t border-app-border">
 <button
 onClick={() => window.location.href = `http://saas.${branding.domain}/dashboard`}
 className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border border-app-border text-app-text-muted hover:text-app-primary hover:border-app-success hover:bg-app-surface transition-all text-[10px] font-black uppercase tracking-widest shadow-sm"
 >
