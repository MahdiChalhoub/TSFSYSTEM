...
export default function ScopePasswordModal({
 ...
 return (
 <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
 <div className="bg-app-surface rounded-[32px] shadow-2xl w-full max-w-lg animate-in fade-in zoom-in duration-300">
 {/* Header */}
 <div className="px-8 py-6 border-b border-gray-50 flex justify-between items-center">
 <div>
 <h2 className="text-xl font-black text-app-text">Access Passwords</h2>
 <p className="text-xs text-app-text-faint font-bold mt-1">{employee.firstName} {employee.lastName}</p>
 </div>
 <button onClick={onClose} className="p-2 hover:bg-app-bg rounded-xl transition-all text-app-text-faint hover:text-app-text">
 <X size={18} />
 </button>
 </div>
 ...
 <p className="text-[11px] text-app-text-muted">Alternative login password that grants <strong>standard access</strong>.</p>
 ...
 <p className="text-[11px] text-app-text-muted">Alternative login password that grants <strong>elevated access</strong> with full data visibility.</p>
 <div className="flex gap-2">
 <input
 type="password"
 value={internalPin}
 ...
 placeholder="Enter new password..."
 className="flex-1 px-4 py-3 rounded-xl bg-app-surface border border-app-border focus:ring-2 focus:ring-gray-200 outline-none text-sm font-medium"
 />
 <button
