...
export function DashboardHeader() {
 ...
 return (
 <div className="relative mb-4 p-4 rounded-[1.5rem] bg-app-surface border border-slate-800 shadow-xl overflow-hidden group">
 <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-3">
 <div>
 <div className="flex items-center gap-2 text-app-primary font-bold tracking-wider text-[10px] uppercase mb-0.5">
 ...
 <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-app-primary/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
 <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-app-info-bg rounded-full blur-[120px] translate-y-1/2 -translate-x-1/3 pointer-events-none"></div>
