...
export function GroupedProductForm({ brands, categories, units, countries, initialGroup }: Props) {
 ...
 <div className="col-span-2 md:col-span-1">
 <label className="text-[10px] uppercase font-bold text-app-text-muted">Origin Country</label>
 <select
 ...
 <div>
 <label className="text-[10px] uppercase font-bold text-app-text-muted">SKU</label>
 <input
 className="w-full text-sm p-2 rounded-lg border border-app-border"
 value={variant.sku}
 ...
 <div>
 <label className="text-[10px] uppercase font-bold text-app-text-muted">Barcode</label>
 <input
 className="w-full text-sm p-2 rounded-lg border border-app-border"
 ...
 <label className="text-[10px] uppercase font-bold text-app-text-muted">Emballage / Size</label>
 <input
 type="number"
 className="w-full text-sm p-2 rounded-lg border border-app-border"
 value={variant.size}
 ...
 <div className="w-16">
 <label className="text-[10px] uppercase font-bold text-app-text-muted">Unit</label>
 <select
 className="w-full text-sm p-2 rounded-lg border border-app-border"
 ...
 <div>
 <label className="text-[10px] uppercase font-bold text-app-text-muted">Cost $</label>
 <input
 type="number"
 className="w-full text-sm p-2 rounded-lg border border-app-border"
 ...
 <div>
 <label className="text-[10px] uppercase font-bold text-app-text-muted">Price $</label>
 <input
 type="number"
 className="w-full text-sm p-2 rounded-lg border border-app-border"
