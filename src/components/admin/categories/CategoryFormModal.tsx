...
export function CategoryFormModal({ isOpen, onClose, category, parentId, potentialParents = [] }: CategoryFormModalProps) {
 ...
 <label className="text-xs font-bold text-app-text-muted uppercase tracking-wide">Category Name</label>
 <input
 name="name"
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold text-app-text-muted uppercase tracking-wide">Code (Unique)</label>
 <input
 name="code"
