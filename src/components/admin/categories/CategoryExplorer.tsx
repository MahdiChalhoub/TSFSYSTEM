...
export function CategoryExplorer({
 ...
 <SheetTitle className="text-3xl font-extrabold text-app-text tracking-tight">
 {categoryName || 'Loading...'}
 </SheetTitle>
 <SheetDescription className="text-app-text-muted font-medium">
 ...
 <p className="font-bold text-app-text-faint">No products found for this category.</p>
 </div>
 ) : (
 <div className="grid gap-3">
 {filteredProducts.map((p, idx) => (
 <div key={p.id} className="group flex items-center gap-4 p-3 bg-app-surface border border-app-border rounded-2xl hover:shadow-xl hover:border-orange-200 transition-all duration-300 cursor-pointer animate-in fade-in slide-in-from-bottom-2" style={{ animationDelay: `${idx * 20}ms` }}>
 <div className="w-14 h-14 bg-app-bg rounded-xl flex-shrink-0 flex items-center justify-center border border-app-border overflow-hidden relative">
 {p.image_url ? (
