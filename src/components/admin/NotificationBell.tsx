...
export function NotificationBell() {
 ...
 <div className="w-12 h-12 bg-app-bg rounded-full flex items-center justify-center mb-3">
 <Bell className="text-gray-300" size={24} />
 </div>
 <p className="text-sm font-bold text-app-text-faint">All caught up!</p>
 ...
 !notif.read_at ? "text-app-text" : "text-app-text-muted"
 )}>
 {notif.title}
 </p>
