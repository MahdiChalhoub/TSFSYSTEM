            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in duration-200">
                <div className="p-6">
                    <div className="flex justify-between items-start mb-4">
                        <div className="w-12 h-12 rounded-full bg-app-warning-soft flex items-center justify-center text-app-warning">
                            <ShieldAlert size={24} />
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <label className="block text-xs font-semibold text-app-muted-foreground uppercase tracking-wider mb-2">
                                Manager PIN
                            </label>
                            <input
                                type="password"
                                ...
                                placeholder="••••"
                                className={`w-full text-center text-3xl tracking-[1em] py-4 bg-gray-50 border-2 rounded-xl focus:outline-none transition-all ${error ? 'border-app-error bg-app-error-soft text-app-error' : 'border-app-border focus:border-app-warning focus:bg-white'
                                    }`}
                                autoFocus
                            />
                            {error && (
                        ...
                        <button
                            ...
                            className={`w-full py-4 rounded-xl flex items-center justify-center gap-2 font-bold text-lg transition-all ${pin.length >= 4
                                    ...
                                    : 'bg-gray-100 text-app-muted-foreground cursor-not-allowed'
                                }`}
                        >
                            {loading ? (
                ...
                <div className="px-6 py-4 bg-gray-50 border-t border-app-border">
