...
export default function ManagerOverrideModal({
 ...
 <button
 onClick={onClose}
 className="text-app-text-faint hover:text-app-text-muted transition-colors"
 >
 <X size={20} />
 </button>
 </div>
 <h3 className="text-xl font-bold text-app-text">{title}</h3>
 <p className="text-sm text-app-text-muted mt-1 mb-6">{description}</p>
 <form onSubmit={handleSubmit} className="space-y-4">
 <div>
 <label className="block text-xs font-semibold text-app-text-faint uppercase tracking-wider mb-2">
 Manager PIN
 </label>
 <input
 type="password"
 ...
 <div className="px-6 py-4 bg-app-bg border-t border-app-border">
 <div className="flex items-center gap-2 text-[10px] text-app-text-faint font-medium">
