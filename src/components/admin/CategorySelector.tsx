...
export function CategorySelector({ categories, onChange, initialCategoryId, compact = false }: Props) {
 ...
 return <p className="text-[11px] text-app-text-faint italic py-2">No categories defined.</p>;
 }
 ...
 ? "block text-[10px] uppercase text-app-text-faint font-semibold mb-1 tracking-wider"
 : "block text-[10px] font-medium text-app-text-faint uppercase tracking-wider mb-1"
 }>
