                        ...
                        <div className="flex items-center gap-3">
                            <div className="relative">
                                ...
                                <input type="text" placeholder="Filter..." value={searchFilter} onChange={(e) => setSearchFilter(e.target.value)}
                                    className="pl-9 pr-8 py-2 bg-app-bg border border-app-border rounded-xl text-sm font-medium text-app-muted-foreground outline-none focus:border-emerald-400 w-48 transition-all placeholder:text-gray-300" />
                                {searchFilter && <button onClick={() => setSearchFilter('')} className="absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-300 hover:text-app-muted-foreground"><X className="w-4 h-4" /></button>}
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="p-5 space-y-4">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                                    {[
                                        ...
                                        { label: 'NOT Linked', value: diag.not_linked || 0, color: diag.not_linked > 0 ? 'text-red-600' : 'text-app-muted-foreground', bg: diag.not_linked > 0 ? 'bg-red-50' : 'bg-app-bg' },
                                    ].map(s => (
                            ...
                            <div className="p-5 space-y-4">
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                    {[
                                        ...
                                        { label: 'Draft', value: diag.draft || 0, color: diag.draft > 0 ? 'text-amber-600' : 'text-app-muted-foreground', bg: diag.draft > 0 ? 'bg-amber-50' : 'bg-app-bg' },
                            ...
                            <div className="p-5 space-y-4">
                                <div className="grid grid-cols-3 gap-3">
                                    ...
                                    <div className={`${(diag.not_linked || 0) > 0 ? 'bg-red-50' : 'bg-app-bg'} p-3 rounded-xl border border-app-border`}>
                                        ...
                                        <p className={`text-2xl font-black ${(diag.not_linked || 0) > 0 ? 'text-red-600' : 'text-app-muted-foreground'}`}>{diag.not_linked || 0}</p>
                                    </div>
                            ...
                            <div className="p-5 space-y-4">
                                <div className="grid grid-cols-3 gap-3">
                                    <div className={`${(diag.draft || 0) > 0 ? 'bg-amber-50' : 'bg-app-bg'} p-3 rounded-xl border border-app-border`}>
                                        ...
                                        <p className={`text-2xl font-black ${(diag.draft || 0) > 0 ? 'text-amber-600' : 'text-app-muted-foreground'}`}>{diag.draft || 0}</p>
                                    </div>
                                    <div className="bg-emerald-50 p-3 rounded-xl border border-app-border">
