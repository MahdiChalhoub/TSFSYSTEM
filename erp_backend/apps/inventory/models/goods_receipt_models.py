...
class GoodsReceiptLine(AuditLogMixin, TenantOwnedModel):
    ...
    # Denormalized identity (frozen at receipt time)
    ...
    product_brand_snapshot = models.CharField(max_length=255, null=True, blank=True,
        help_text='Brand name at time of receipt (immutable)')
    product_uom_snapshot = models.CharField(max_length=50, null=True, blank=True,
        help_text='Unit of measure at time of receipt (immutable)')
    product_tax_code_snapshot = models.CharField(max_length=50, null=True, blank=True,
