...
class ChartOfAccountViewSet(UDLEViewSetMixin, TenantModelViewSet):
    ...
    def apply_template(self, request):
        ...
        try:
            ...
            # ── Phase 3: Remap journal entries using account_mapping ──
            remapped_count = 0
            remap_errors = []
            if account_mapping:
                with db_transaction.atomic():
                    ...
                    for source_code, target_code in account_mapping.items():
                        ...
                        # Remap all journal entry lines referencing the old account
            ...
            return Response({
                "message": f"Template applied successfully. {posting_synced} posting rules synced. {remapped_count} journal lines remapped.",
