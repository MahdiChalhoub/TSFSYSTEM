...
class Contact(TenantModel):
    ...
    linked_account = models.OneToOneField('erp.ChartOfAccount', on_delete=models.SET_NULL, null=True, blank=True, related_name='contact')
...
class Employee(TenantModel):
    ...
    linked_account = models.OneToOneField('erp.ChartOfAccount', on_delete=models.SET_NULL, null=True, blank=True, related_name='employee')
