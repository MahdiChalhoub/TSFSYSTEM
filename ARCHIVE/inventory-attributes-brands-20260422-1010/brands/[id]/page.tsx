    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-app-foreground">{brand.name}</h1>
            ...
            <div className="grid gap-6">
                {(brand.productGroups?.length || 0) === 0 && (brand.products?.length || 0) === 0 && (
                    <div className="p-8 text-center text-app-muted-foreground bg-app-surface rounded-xl">No products found for this brand.</div>
                )}
                                ...
                                <div className="divide-y divide-gray-50">
                                    {group.products.length === 0 ? (
                                        ...
                                        group.products.map(variant => {
                                            ...
                                            return (
                                                <div key={variant.id} className="p-3 pl-12 flex justify-between items-center hover:bg-app-surface transition-colors group">
                                                    <div className="flex items-center gap-3">
