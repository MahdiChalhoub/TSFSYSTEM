...
export function UnitCalculator({ units = [] }: { units?: Unit[] }) {
    ...
    return (
        <div className="card-premium p-6 bg-blue-50/30 border-blue-100">
            <h3 className="font-bold text-gray-900 mb-4">Unit Conversion Calculator</h3>
            <div className="flex flex-col md:flex-row items-end gap-4">
                ...
                <div className="flex-1 w-full">
                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase tracking-wider">From Unit</label>
                    <select
                        className="input-field bg-white"
                        value={fromUnitId}
                ...
                <div className="flex-1 w-full">
                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase tracking-wider">To Unit</label>
                    <select
                        className="input-field bg-white"
                        value={toUnitId}
                ...
                <div className="flex-1 w-full">
                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase tracking-wider">Result</label>
