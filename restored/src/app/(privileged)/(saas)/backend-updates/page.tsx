            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 sm:gap-4">
                <div className="w-full sm:w-auto">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 tracking-tight">Backend Updates</h2>
                    </div>
                    <p className="text-gray-500 mt-2 font-medium text-sm md:text-base">Django backend kernel updates for the Dajingo Platform</p>
                </div>
